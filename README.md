# Painted Abyss — First Dive · 0.8.3
...
- **The Soviet guard patrols the whole building.** He walks one loop round the perimeter of every room (corridor, cavern, relic chamber, fissure and exit pool), about 1.3 m off the walls, stopping at every corner and every ~16 m along long walls to look around before walking on. At each stop he surveys the open floor around him, turns (through the room, not across the wall) to face the longest view into the room, sweeps across it, and where the space opens two ways (a corridor, a second doorway) checks the other way too. He sees what is in front of him (≈65° either side; a lit torch from 16 m, dark from 9 m), hears you running within 11 m, and senses anyone within 2.5 m. Each time you respawn he starts from a different stop on the loop, at least 30 m from the hatch, never the same stop twice running. When he loses you he searches, then rejoins the loop at the nearest stop. He cannot swim, so once the leak passes the walk line he holds his ground.
- **The guard shoots on sight.** He carries the TT-33 as his own sidearm. The moment he spots you he stops, raises the pistol (about 0.35 s) and fires aimed shots roughly every 0.75 s from a standing stance, reloading for 2.2 s after each 8-round magazine. Hits cost 30 suit (less with the coat); misses crack past with a ricochet. Close, steady targets are almost always hit; long shots in the dark, running targets and his rushed first shot often miss, so breaking his line of sight or sprinting for cover is how you survive. A soft key and rim light keep his face and uniform readable in the dark.
...
- **Copper pipe section** (CC BY 4.0): [Copper Pipe Section](https://sketchfab.com/3d-models/copper-pipe-section-91807ce330af449bbd3c59b5ede8ce67) (pixol3d). Official glTF under `playable/public/assets/copper-pipe/`. A 2.4 m section on the east wall of the breath corridor.

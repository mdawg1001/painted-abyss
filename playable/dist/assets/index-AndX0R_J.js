...
`)+`
`+y);const U=L+M+u,w=L+y+h,O=p_(o,o.VERTEX_SHADER,U),P=p_(o,o.FRAGMENT_SHADER,w);o.attachShader(E,O),o.attachShader(E,P),n.index0AttributeName!==void 0?o.bindAttribLocation(E,0,n.index0AttributeName):n.morphTargets===!0&&o.bindAttribLocation(E,0,"position"),o.linkProgram(E);function F(V){if(r.debug.checkShaderErrors){const q=o.getProgramInfoLog(E)||"",rt=o.getShaderInfoLog(O)||"",ut=o.getShaderInfoLog(P)||"",ft=q.trim(),B=rt.trim(),tt=ut.trim();let Y=!0,ot=!0;if(o.getProgramParameter(E,o.LINK_STATUS)===!1)if(Y=!1,typeof r.debug.onShaderError=="function")r.debug.onShaderError(o,E,O,P);else{const N=g_(o,O,"vertex"),Z=g_(o,P,"fragment");console.error("THREE.WebGLProgram: Shader Error "+o.getError()+" - VALIDATE_STATUS "+o.getProgramParameter(E,o.VALIDATE_STATUS)+`

...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:pa,depthTest:!1,depthWrite:!1})}function qv(){return new Mn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Sp(),fragmentShader:`
		...
		`,blending:pa,depthTest:!1,depthWrite:!1})}function Yv(){return new Mn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Sp(),fragmentShader:`

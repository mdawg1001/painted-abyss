 ...
 */var sv;function AM(){if(sv)return Qo;sv=1;var r=Symbol.for("react.transitional.element"),t=Symbol.for("react.fragment");function n(a,o,c){var u=null;if(c!==void 0&&(u=""+c),o.key!==void 0&&(u=""+o.key),"key"in o){c={};for(var h in o)h!=="key"&&(c[h]=o[h])}else c=o;return o=c.ref,{$$typeof:r,type:a,key:u,ref:o!==void 0?o:null,props:c}}return Qo.Fragment=t,Qo.jsx=n,Qo.jsxs=n,Qo}var rv;function wM(){return rv||(rv=1,Dh.exports=AM()),Dh.exports}var J=wM(),Uh={exports:{}},de={};/**
 * @license React
 * react.production.js
 *
 * Copyright (c) Meta Platforms, Inc. and affiliates.
...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:ma,depthTest:!1,depthWrite:!1})}function e_(){return new yn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Dp(),fragmentShader:`
		...
		`,blending:ma,depthTest:!1,depthWrite:!1})}function n_(){return new yn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Dp(),fragmentShader:`
		...
		`,blending:ma,depthTest:!1,depthWrite:!1})}function Dp(){return`
...
`+S_;p&&c&&(d.uniforms.uPbrDiff={value:c.diff},d.uniforms.uPbrNor={value:c.nor},d.uniforms.uPbrArm={value:c.arm},d.uniforms.uPbrScale={value:c.scale},g+=`uniform sampler2D uPbrDiff;uniform sampler2D uPbrNor;uniform sampler2D uPbrArm;uniform float uPbrScale;

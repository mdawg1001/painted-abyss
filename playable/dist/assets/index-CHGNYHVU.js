...
#define LOW_PRECISION`),t}function jb(r){let t="SHADOWMAP_TYPE_BASIC";return r.shadowMapType===c_?t="SHADOWMAP_TYPE_PCF":r.shadowMapType===lM?t="SHADOWMAP_TYPE_PCF_SOFT":r.shadowMapType===ua&&(t="SHADOWMAP_TYPE_VSM"),t}function Zb(r){let t="ENVMAP_TYPE_CUBE";if(r.envMap)switch(r.envMapMode){case zr:case Br:t="ENVMAP_TYPE_CUBE";break;case du:t="ENVMAP_TYPE_CUBE_UV";break}return t}function Kb(r){let t="ENVMAP_MODE_REFLECTION";if(r.envMap)switch(r.envMapMode){case Br:t="ENVMAP_MODE_REFRACTION";break}return t}function Qb(r){let t="ENVMAP_BLENDING_NONE";if(r.envMap)switch(r.combine){case u_:t="ENVMAP_BLENDING_MULTIPLY";break;case RM:t="ENVMAP_BLENDING_MIX";break;case wM:t="ENVMAP_BLENDING_ADD";break}return t}function Jb(r){const t=r.envMapCubeUVHeight;if(t===null)return null;const n=Math.log2(t)-2,a=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,n),112)),texelHeight:a,maxMip:n}}function $b(r,t,n,a){const l=r.getContext(),c=n.defines;let u=n.vertexShader,h=n.fragmentShader;const m=jb(n),d=Zb(n),g=Kb(n),v=Qb(n),_=Jb(n),x=Hb(n),S=Gb(c),T=l.createProgram();let M,y,U=n.glslVersion?"#version "+n.glslVersion+`

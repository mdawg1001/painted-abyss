 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var fv;function DM(){if(fv)return de;fv=1;var r=Symbol.for("react.transitional.element"),t=Symbol.for("react.portal"),n=Symbol.for("react.fragment"),a=Symbol.for("react.strict_mode"),o=Symbol.for("react.profiler"),c=Symbol.for("react.consumer"),u=Symbol.for("react.context"),h=Symbol.for("react.forward_ref"),d=Symbol.for("react.suspense"),p=Symbol.for("react.memo"),g=Symbol.for("react.lazy"),v=Symbol.iterator;function _(N){return N===null||typeof N!="object"?null:(N=v&&N[v]||N["@@iterator"],typeof N=="function"?N:null)}var x={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},S=Object.assign,E={};function M(N,Z,dt){this.props=N,this.context=Z,this.refs=E,this.updater=dt||x}M.prototype.isReactComponent={},M.prototype.setState=function(N,Z){if(typeof N!="object"&&typeof N!="function"&&N!=null)throw Error("takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,N,Z,"setState")},M.prototype.forceUpdate=function(N){this.updater.enqueueForceUpdate(this,N,"forceUpdate")};function y(){}y.prototype=M.prototype;function L(N,Z,dt){this.props=N,this.context=Z,this.refs=E,this.updater=dt||x}var U=L.prototype=new y;U.constructor=L,S(U,M.prototype),U.isPureReactComponent=!0;var w=Array.isArray,P={H:null,A:null,T:null,S:null,V:null},O=Object.prototype.hasOwnProperty;function F(N,Z,dt,vt,At,Gt){return dt=Gt.ref,{$$typeof:r,type:N,key:Z,ref:dt!==void 0?dt:null,props:Gt}}function G(N,Z){return F(N.type,Z,void 0,void 0,void 0,N.props)}function R(N){return typeof N=="object"&&N!==null&&N.$$typeof===r}function D(N){var Z={"=":"=0",":":"=2"};return"$"+N.replace(/[=:]/g,function(dt){return Z[dt]})}var V=/\/+/g;function W(N,Z){return typeof N=="object"&&N!==null&&N.key!=null?D(""+N.key):Z.toString(36)}function nt(){}function ot(N){switch(N.status){case"fulfilled":return N.value;case"rejected":throw N.reason;default:switch(typeof N.status=="string"?N.then(nt,nt):(N.status="pending",N.then(function(Z){N.status==="pending"&&(N.status="fulfilled",N.value=Z)},function(Z){N.status==="pending"&&(N.status="rejected",N.reason=Z)})),N.status){case"fulfilled":return N.value;case"rejected":throw N.reason}}throw N}function ft(N,Z,dt,vt,At){var Gt=typeof N;(Gt==="undefined"||Gt==="boolean")&&(N=null);var at=!1;if(N===null)at=!0;else switch(Gt){case"bigint":case"string":case"number":at=!0;break;case"object":switch(N.$$typeof){case r:case t:at=!0;break;case g:return at=N._init,ft(at(N._payload),Z,dt,vt,At)}}if(at)return At=At(N),at=vt===""?"."+W(N,0):vt,w(At)?(dt="",at!=null&&(dt=at.replace(V,"$&/")+"/"),ft(At,Z,dt,"",function($t){return $t})):At!=null&&(R(At)&&(At=G(At,dt+(At.key==null||N&&N.key===At.key?"":(""+At.key).replace(V,"$&/")+"/")+at)),Z.push(At)),1;at=0;var yt=vt===""?".":vt+":";if(w(N))for(var wt=0;wt<N.length;wt++)vt=N[wt],Gt=yt+W(vt,wt),at+=ft(vt,Z,dt,Gt,At);else if(wt=_(N),typeof wt=="function")for(N=wt.call(N),wt=0;!(vt=N.next()).done;)vt=vt.value,Gt=yt+W(vt,wt++),at+=ft(vt,Z,dt,Gt,At);else if(Gt==="object"){if(typeof N.then=="function")return ft(ot(N),Z,dt,vt,At);throw Z=String(N),Error("Objects are not valid as a React child (found: "+(Z==="[object Object]"?"object with keys {"+Object.keys(N).join(", ")+"}":Z)+"). If you meant to render a collection of children, use an array instead.")}return at}function B(N,Z,dt){if(N==null)return N;var vt=[],At=0;return ft(N,vt,"","",function(Gt){return Z.call(dt,Gt,At++)}),vt}function tt(N){if(N._status===-1){var Z=N._result;Z=Z(),Z.then(function(dt){(N._status===0||N._status===-1)&&(N._status=1,N._result=dt)},function(dt){(N._status===0||N._status===-1)&&(N._status=2,N._result=dt)}),N._status===-1&&(N._status=0,N._result=Z)}if(N._status===1)return N._result.default;throw N._result}var Y=typeof reportError=="function"?reportError:function(N){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var Z=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof N=="object"&&N!==null&&typeof N.message=="string"?String(N.message):String(N),error:N});if(!window.dispatchEvent(Z))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",N);return}console.error(N)};function lt(){}return de.Children={map:B,forEach:function(N,Z,dt){B(N,function(){Z.apply(this,arguments)},dt)},count:function(N){var Z=0;return B(N,function(){Z++}),Z},toArray:function(N){return B(N,function(Z){return Z})||[]},only:function(N){if(!R(N))throw Error("React.Children.only expected to receive a single React element child.");return N}},de.Component=M,de.Fragment=n,de.Profiler=o,de.PureComponent=L,de.StrictMode=a,de.Suspense=d,de.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=P,de.__COMPILER_RUNTIME={__proto__:null,c:function(N){return P.H.useMemoCache(N)}},de.cache=function(N){return function(){return N.apply(null,arguments)}},de.cloneElement=function(N,Z,dt){if(N==null)throw Error("The argument must be a React element, but you passed "+N+".");var vt=S({},N.props),At=N.key,Gt=void 0;if(Z!=null)for(at in Z.ref!==void 0&&(Gt=void 0),Z.key!==void 0&&(At=""+Z.key),Z)!O.call(Z,at)||at==="key"||at==="__self"||at==="__source"||at==="ref"&&Z.ref===void 0||(vt[at]=Z[at]);var at=arguments.length-2;if(at===1)vt.children=dt;else if(1<at){for(var yt=Array(at),wt=0;wt<at;wt++)yt[wt]=arguments[wt+2];vt.children=yt}return F(N.type,At,void 0,void 0,Gt,vt)},de.createContext=function(N){return N={$$typeof:u,_currentValue:N,_currentValue2:N,_threadCount:0,Provider:null,Consumer:null},N.Provider=N,N.Consumer={$$typeof:c,_context:N},N},de.createElement=function(N,Z,dt){var vt,At={},Gt=null;if(Z!=null)for(vt in Z.key!==void 0&&(Gt=""+Z.key),Z)O.call(Z,vt)&&vt!=="key"&&vt!=="__self"&&vt!=="__source"&&(At[vt]=Z[vt]);var at=arguments.length-2;if(at===1)At.children=dt;else if(1<at){for(var yt=Array(at),wt=0;wt<at;wt++)yt[wt]=arguments[wt+2];At.children=yt}if(N&&N.defaultProps)for(vt in at=N.defaultProps,at)At[vt]===void 0&&(At[vt]=at[vt]);return F(N,Gt,void 0,void 0,null,At)},de.createRef=function(){return{current:null}},de.forwardRef=function(N){return{$$typeof:h,render:N}},de.isValidElement=R,de.lazy=function(N){return{$$typeof:g,_payload:{_status:-1,_result:N},_init:tt}},de.memo=function(N,Z){return{$$typeof:p,type:N,compare:Z===void 0?null:Z}},de.startTransition=function(N){var Z=P.T,dt={};P.T=dt;try{var vt=N(),At=P.S;At!==null&&At(dt,vt),typeof vt=="object"&&vt!==null&&typeof vt.then=="function"&&vt.then(lt,Y)}catch(Gt){Y(Gt)}finally{P.T=Z}},de.unstable_useCacheRefresh=function(){return P.H.useCacheRefresh()},de.use=function(N){return P.H.use(N)},de.useActionState=function(N,Z,dt){return P.H.useActionState(N,Z,dt)},de.useCallback=function(N,Z){return P.H.useCallback(N,Z)},de.useContext=function(N){return P.H.useContext(N)},de.useDebugValue=function(){},de.useDeferredValue=function(N,Z){return P.H.useDeferredValue(N,Z)},de.useEffect=function(N,Z,dt){var vt=P.H;if(typeof dt=="function")throw Error("useEffect CRUD overload is not enabled in this build of React.");return vt.useEffect(N,Z)},de.useId=function(){return P.H.useId()},de.useImperativeHandle=function(N,Z,dt){return P.H.useImperativeHandle(N,Z,dt)},de.useInsertionEffect=function(N,Z){return P.H.useInsertionEffect(N,Z)},de.useLayoutEffect=function(N,Z){return P.H.useLayoutEffect(N,Z)},de.useMemo=function(N,Z){return P.H.useMemo(N,Z)},de.useOptimistic=function(N,Z){return P.H.useOptimistic(N,Z)},de.useReducer=function(N,Z,dt){return P.H.useReducer(N,Z,dt)},de.useRef=function(N){return P.H.useRef(N)},de.useState=function(N){return P.H.useState(N)},de.useSyncExternalStore=function(N,Z,dt){return P.H.useSyncExternalStore(N,Z,dt)},de.useTransition=function(){return P.H.useTransition()},de.version="19.1.1",de}var hv;function hp(){return hv||(hv=1,Uh.exports=DM()),Uh.exports}var ys=hp(),Lh={exports:{}},Jo={},Nh={exports:{}},Ph={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var dv;function UM(){return dv||(dv=1,(function(r){function t(B,tt){var Y=B.length;B.push(tt);t:for(;0<Y;){var lt=Y-1>>>1,N=B[lt];if(0<o(N,tt))B[lt]=tt,B[Y]=N,Y=lt;else break t}}function n(B){return B.length===0?null:B[0]}function a(B){if(B.length===0)return null;var tt=B[0],Y=B.pop();if(Y!==tt){B[0]=Y;t:for(var lt=0,N=B.length,Z=N>>>1;lt<Z;){var dt=2*(lt+1)-1,vt=B[dt],At=dt+1,Gt=B[At];if(0>o(vt,Y))At<N&&0>o(Gt,vt)?(B[lt]=Gt,B[At]=Y,lt=At):(B[lt]=vt,B[dt]=Y,lt=dt);else if(At<N&&0>o(Gt,Y))B[lt]=Gt,B[At]=Y,lt=At;else break t}}return tt}function o(B,tt){var Y=B.sortIndex-tt.sortIndex;return Y!==0?Y:B.id-tt.id}if(r.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var c=performance;r.unstable_now=function(){return c.now()}}else{var u=Date,h=u.now();r.unstable_now=function(){return u.now()-h}}var d=[],p=[],g=1,v=null,_=3,x=!1,S=!1,E=!1,M=!1,y=typeof setTimeout=="function"?setTimeout:null,L=typeof clearTimeout=="function"?clearTimeout:null,U=typeof setImmediate<"u"?setImmediate:null;function w(B){for(var tt=n(p);tt!==null;){if(tt.callback===null)a(p);else if(tt.startTime<=B)a(p),tt.sortIndex=tt.expirationTime,t(d,tt);else break;tt=n(p)}}function P(B){if(E=!1,w(B),!S)if(n(d)!==null)S=!0,O||(O=!0,W());else{var tt=n(p);tt!==null&&ft(P,tt.startTime-B)}}var O=!1,F=-1,G=5,R=-1;function D(){return M?!0:!(r.unstable_now()-R<G)}function V(){if(M=!1,O){var B=r.unstable_now();R=B;var tt=!0;try{t:{S=!1,E&&(E=!1,L(F),F=-1),x=!0;var Y=_;try{e:{for(w(B),v=n(d);v!==null&&!(v.expirationTime>B&&D());){var lt=v.callback;if(typeof lt=="function"){v.callback=null,_=v.priorityLevel;var N=lt(v.expirationTime<=B);if(B=r.unstable_now(),typeof N=="function"){v.callback=N,w(B),tt=!0;break e}v===n(d)&&a(d),w(B)}else a(d);v=n(d)}if(v!==null)tt=!0;else{var Z=n(p);Z!==null&&ft(P,Z.startTime-B),tt=!1}}break t}finally{v=null,_=Y,x=!1}tt=void 0}}finally{tt?W():O=!1}}}var W;if(typeof U=="function")W=function(){U(V)};else if(typeof MessageChannel<"u"){var nt=new MessageChannel,ot=nt.port2;nt.port1.onmessage=V,W=function(){ot.postMessage(null)}}else W=function(){y(V,0)};function ft(B,tt){F=y(function(){B(r.unstable_now())},tt)}r.unstable_IdlePriority=5,r.unstable_ImmediatePriority=1,r.unstable_LowPriority=4,r.unstable_NormalPriority=3,r.unstable_Profiling=null,r.unstable_UserBlockingPriority=2,r.unstable_cancelCallback=function(B){B.callback=null},r.unstable_forceFrameRate=function(B){0>B||125<B?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):G=0<B?Math.floor(1e3/B):5},r.unstable_getCurrentPriorityLevel=function(){return _},r.unstable_next=function(B){switch(_){case 1:case 2:case 3:var tt=3;break;default:tt=_}var Y=_;_=tt;try{return B()}finally{_=Y}},r.unstable_requestPaint=function(){M=!0},r.unstable_runWithPriority=function(B,tt){switch(B){case 1:case 2:case 3:case 4:case 5:break;default:B=3}var Y=_;_=B;try{return tt()}finally{_=Y}},r.unstable_scheduleCallback=function(B,tt,Y){var lt=r.unstable_now();switch(typeof Y=="object"&&Y!==null?(Y=Y.delay,Y=typeof Y=="number"&&0<Y?lt+Y:lt):Y=lt,B){case 1:var N=-1;break;case 2:N=250;break;case 5:N=1073741823;break;case 4:N=1e4;break;default:N=5e3}return N=Y+N,B={id:g++,callback:tt,priorityLevel:B,startTime:Y,expirationTime:N,sortIndex:-1},Y>lt?(B.sortIndex=Y,t(p,B),n(d)===null&&B===n(p)&&(E?(L(F),F=-1):E=!0,ft(P,Y-lt))):(B.sortIndex=N,t(d,B),S||x||(S=!0,O||(O=!0,W()))),B},r.unstable_shouldYield=D,r.unstable_wrapCallback=function(B){var tt=_;return function(){var Y=_;_=tt;try{return B.apply(this,arguments)}finally{_=Y}}}})(Ph)),Ph}var pv;function LM(){return pv||(pv=1,Nh.exports=UM()),Nh.exports}var Oh={exports:{}},Bn={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var vv;function OM(){if(vv)return Jo;vv=1;var r=LM(),t=hp(),n=PM();function a(e){var i="https://react.dev/errors/"+e;if(1<arguments.length){i+="?args[]="+encodeURIComponent(arguments[1]);for(var s=2;s<arguments.length;s++)i+="&args[]="+encodeURIComponent(arguments[s])}return"Minified React error #"+e+"; visit "+i+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}function o(e){return!(!e||e.nodeType!==1&&e.nodeType!==9&&e.nodeType!==11)}function c(e){var i=e,s=e;if(e.alternate)for(;i.return;)i=i.return;else{e=i;do i=e,(i.flags&4098)!==0&&(s=i.return),e=i.return;while(e)}return i.tag===3?s:null}function u(e){if(e.tag===13){var i=e.memoizedState;if(i===null&&(e=e.alternate,e!==null&&(i=e.memoizedState)),i!==null)return i.dehydrated}return null}function h(e){if(c(e)!==e)throw Error(a(188))}function d(e){var i=e.alternate;if(!i){if(i=c(e),i===null)throw Error(a(188));return i!==e?null:e}for(var s=e,l=i;;){var f=s.return;if(f===null)break;var m=f.alternate;if(m===null){if(l=f.return,l!==null){s=l;continue}break}if(f.child===m.child){for(m=f.child;m;){if(m===s)return h(f),e;if(m===l)return h(f),i;m=m.sibling}throw Error(a(188))}if(s.return!==l.return)s=f,l=m;else{for(var b=!1,A=f.child;A;){if(A===s){b=!0,s=f,l=m;break}if(A===l){b=!0,l=f,s=m;break}A=A.sibling}if(!b){for(A=m.child;A;){if(A===s){b=!0,s=m,l=f;break}if(A===l){b=!0,l=m,s=f;break}A=A.sibling}if(!b)throw Error(a(189))}}if(s.alternate!==l)throw Error(a(190))}if(s.tag!==3)throw Error(a(188));return s.stateNode.current===s?e:i}function p(e){var i=e.tag;if(i===5||i===26||i===27||i===6)return e;for(e=e.child;e!==null;){if(i=p(e),i!==null)return i;e=e.sibling}return null}var g=Object.assign,v=Symbol.for("react.element"),_=Symbol.for("react.transitional.element"),x=Symbol.for("react.portal"),S=Symbol.for("react.fragment"),E=Symbol.for("react.strict_mode"),M=Symbol.for("react.profiler"),y=Symbol.for("react.provider"),L=Symbol.for("react.consumer"),U=Symbol.for("react.context"),w=Symbol.for("react.forward_ref"),P=Symbol.for("react.suspense"),O=Symbol.for("react.suspense_list"),F=Symbol.for("react.memo"),G=Symbol.for("react.lazy"),R=Symbol.for("react.activity"),D=Symbol.for("react.memo_cache_sentinel"),V=Symbol.iterator;function W(e){return e===null||typeof e!="object"?null:(e=V&&e[V]||e["@@iterator"],typeof e=="function"?e:null)}var nt=Symbol.for("react.client.reference");function ot(e){if(e==null)return null;if(typeof e=="function")return e.$$typeof===nt?null:e.displayName||e.name||null;if(typeof e=="string")return e;switch(e){case S:return"Fragment";case M:return"Profiler";case E:return"StrictMode";case P:return"Suspense";case O:return"SuspenseList";case R:return"Activity"}if(typeof e=="object")switch(e.$$typeof){case x:return"Portal";case U:return(e.displayName||"Context")+".Provider";case L:return(e._context.displayName||"Context")+".Consumer";case w:var i=e.render;return e=e.displayName,e||(e=i.displayName||i.name||"",e=e!==""?"ForwardRef("+e+")":"ForwardRef"),e;case F:return i=e.displayName||null,i!==null?i:ot(e.type)||"Memo";case G:i=e._payload,e=e._init;try{return ot(e(i))}catch{}}return null}var ft=Array.isArray,B=t.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE,tt=n.__DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE,Y={pending:!1,data:null,method:null,action:null},lt=[],N=-1;function Z(e){return{current:e}}function dt(e){0>N||(e.current=lt[N],lt[N]=null,N--)}function vt(e,i){N++,lt[N]=e.current,e.current=i}var At=Z(null),Gt=Z(null),at=Z(null),yt=Z(null);function wt(e,i){switch(vt(at,i),vt(Gt,e),vt(At,null),i.nodeType){case 9:case 11:e=(e=i.documentElement)&&(e=e.namespaceURI)?Bg(e):0;break;default:if(e=i.tagName,i=i.namespaceURI)i=Bg(i),e=Ig(i,e);else switch(e){case"svg":e=1;break;case"math":e=2;break;default:e=0}}dt(At),vt(At,e)}function $t(){dt(At),dt(Gt),dt(at)}function Zt(e){e.memoizedState!==null&&vt(yt,e);var i=At.current,s=Ig(i,e.type);i!==s&&(vt(Gt,e),vt(At,s))}function _e(e){Gt.current===e&&(dt(At),dt(Gt)),yt.current===e&&(dt(yt),qo._currentValue=Y)}var un=Object.prototype.hasOwnProperty,H=r.unstable_scheduleCallback,Be=r.unstable_cancelCallback,ue=r.unstable_shouldYield,se=r.unstable_requestPaint,Ot=r.unstable_now,qe=r.unstable_getCurrentPriorityLevel,kt=r.unstable_ImmediatePriority,fe=r.unstable_UserBlockingPriority,Qe=r.unstable_NormalPriority,Je=r.unstable_LowPriority,z=r.unstable_IdlePriority,T=r.log,it=r.unstable_setDisableYieldValue,pt=null,_t=null;function ht(e){if(typeof T=="function"&&it(e),_t&&typeof _t.setStrictMode=="function")try{_t.setStrictMode(pt,e)}catch{}}var zt=Math.clz32?Math.clz32:Kt,Rt=Math.log,Yt=Math.LN2;function Kt(e){return e>>>=0,e===0?32:31-(Rt(e)/Yt|0)|0}var St=256,Lt=4194304;function Jt(e){var i=e&42;if(i!==0)return i;switch(e&-e){case 1:return 1;case 2:return 2;case 4:return 4;case 8:return 8;case 16:return 16;case 32:return 32;case 64:return 64;case 128:return 128;case 256:case 512:case 1024:case 2048:case 4096:case 8192:case 16384:case 32768:case 65536:case 131072:case 262144:case 524288:case 1048576:case 2097152:return e&4194048;case 4194304:case 8388608:case 16777216:case 33554432:return e&62914560;case 67108864:return 67108864;case 134217728:return 134217728;case 268435456:return 268435456;case 536870912:return 536870912;case 1073741824:return 0;default:return e}}function Xt(e,i,s){var l=e.pendingLanes;if(l===0)return 0;var f=0,m=e.suspendedLanes,b=e.pingedLanes;e=e.warmLanes;var A=l&134217727;return A!==0?(l=A&~m,l!==0?f=Jt(l):(b&=A,b!==0?f=Jt(b):s||(s=A&~e,s!==0&&(f=Jt(s))))):(A=l&~m,A!==0?f=Jt(A):b!==0?f=Jt(b):s||(s=l&~e,s!==0&&(f=Jt(s)))),f===0?0:i!==0&&i!==f&&(i&m)===0&&(m=f&-f,s=i&-i,m>=s||m===32&&(s&4194048)!==0)?i:f}function Dt(e,i){return(e.pendingLanes&~(e.suspendedLanes&~e.pingedLanes)&i)===0}function he(e,i){switch(e){case 1:case 2:case 4:case 8:case 64:return i+250;case 16:case 32:case 128:case 256:case 512:case 1024:case 2048:case 4096:case 8192:case 16384:case 32768:case 65536:case 131072:case 262144:case 524288:case 1048576:case 2097152:return i+5e3;case 4194304:case 8388608:case 16777216:case 33554432:return-1;case 67108864:case 134217728:case 268435456:case 536870912:case 1073741824:return-1;default:return-1}}function q(){var e=St;return St<<=1,(St&4194048)===0&&(St=256),e}function Tt(){var e=Lt;return Lt<<=1,(Lt&62914560)===0&&(Lt=4194304),e}function Ct(e){for(var i=[],s=0;31>s;s++)i.push(e);return i}function Bt(e,i){e.pendingLanes|=i,i!==268435456&&(e.suspendedLanes=0,e.pingedLanes=0,e.warmLanes=0)}function bt(e,i,s,l,f,m){var b=e.pendingLanes;e.pendingLanes=s,e.suspendedLanes=0,e.pingedLanes=0,e.warmLanes=0,e.expiredLanes&=s,e.entangledLanes&=s,e.errorRecoveryDisabledLanes&=s,e.shellSuspendCounter=0;var A=e.entanglements,I=e.expirationTimes,et=e.hiddenUpdates;for(s=b&~s;0<s;){var mt=31-zt(s),xt=1<<mt;A[mt]=0,I[mt]=-1;var st=et[mt];if(st!==null)for(et[mt]=null,mt=0;mt<st.length;mt++){var rt=st[mt];rt!==null&&(rt.lane&=-536870913)}s&=~xt}l!==0&&Mt(e,l,0),m!==0&&f===0&&e.tag!==0&&(e.suspendedLanes|=m&~(b&~i))}function Mt(e,i,s){e.pendingLanes|=i,e.suspendedLanes&=~i;var l=31-zt(i);e.entangledLanes|=i,e.entanglements[l]=e.entanglements[l]|1073741824|s&4194090}function Vt(e,i){var s=e.entangledLanes|=i;for(e=e.entanglements;s;){var l=31-zt(s),f=1<<l;f&i|e[l]&i&&(e[l]|=i),s&=~f}}function oe(e){switch(e){case 2:e=1;break;case 8:e=4;break;case 32:e=16;break;case 256:case 512:case 1024:case 2048:case 4096:case 8192:case 16384:case 32768:case 65536:case 131072:case 262144:case 524288:case 1048576:case 2097152:case 4194304:case 8388608:case 16777216:case 33554432:e=128;break;case 268435456:e=134217728;break;default:e=0}return e}function Ne(e){return e&=-e,2<e?8<e?(e&134217727)!==0?32:268435456:8:2}function we(){var e=tt.p;return e!==0?e:(e=window.event,e===void 0?32:iv(e.type))}function Mi(e,i){var s=tt.p;try{return tt.p=e,i()}finally{tt.p=s}}var gn=Math.random().toString(36).slice(2),vn="__reactFiber$"+gn,tn="__reactProps$"+gn,Pi="__reactContainer$"+gn,Is="__reactEvents$"+gn,bl="__reactListeners$"+gn,Fs="__reactHandles$"+gn,io="__reactResources$"+gn,Oi="__reactMarker$"+gn;function Hs(e){delete e[vn],delete e[tn],delete e[Is],delete e[bl],delete e[Fs]}function Yi(e){var i=e[vn];if(i)return i;for(var s=e.parentNode;s;){if(i=s[Pi]||s[vn]){if(s=i.alternate,i.child!==null||s!==null&&s.child!==null)for(e=Vg(e);e!==null;){if(s=e[vn])return s;e=Vg(e)}return i}e=s,s=e.parentNode}return null}function ya(e){if(e=e[vn]||e[Pi]){var i=e.tag;if(i===5||i===6||i===13||i===26||i===27||i===3)return e}return null}function is(e){var i=e.tag;if(i===5||i===26||i===27||i===6)return e.stateNode;throw Error(a(33))}function Ma(e){var i=e[io];return i||(i=e[io]={hoistableStyles:new Map,hoistableScripts:new Map}),i}function fn(e){e[Oi]=!0}var El=new Set,Tl={};function C(e,i){j(e,i),j(e+"Capture",i)}function j(e,i){for(Tl[e]=i,e=0;e<i.length;e++)El.add(i[e])}var ct=RegExp("^[:A-Z_a-z\\u00C0-\\u00D6\\u00D8-\\u00F6\\u00F8-\\u02FF\\u0370-\\u037D\\u037F-\\u1FFF\\u200C-\\u200D\\u2070-\\u218F\\u2C00-\\u2FEF\\u3001-\\uD7FF\\uF900-\\uFDCF\\uFDF0-\\uFFFD][:A-Z_a-z\\u00C0-\\u00D6\\u00D8-\\u00F6\\u00F8-\\u02FF\\u0370-\\u037D\\u037F-\\u1FFF\\u200C-\\u200D\\u2070-\\u218F\\u2C00-\\u2FEF\\u3001-\\uD7FF\\uF900-\\uFDCF\\uFDF0-\\uFFFD\\-.0-9\\u00B7\\u0300-\\u036F\\u203F-\\u2040]*$"),ut={},J={};function Et(e){return un.call(J,e)?!0:un.call(ut,e)?!1:ct.test(e)?J[e]=!0:(ut[e]=!0,!1)}function Ut(e,i,s){if(Et(i))if(s===null)e.removeAttribute(i);else{switch(typeof s){case"undefined":case"function":case"symbol":e.removeAttribute(i);return;case"boolean":var l=i.toLowerCase().slice(0,5);if(l!=="data-"&&l!=="aria-"){e.removeAttribute(i);return}}e.setAttribute(i,""+s)}}function Ft(e,i,s){if(s===null)e.removeAttribute(i);else{switch(typeof s){case"undefined":case"function":case"symbol":case"boolean":e.removeAttribute(i);return}e.setAttribute(i,""+s)}}function Nt(e,i,s,l){if(l===null)e.removeAttribute(s);else{switch(typeof l){case"undefined":case"function":case"symbol":case"boolean":e.removeAttribute(s);return}e.setAttributeNS(i,s,""+l)}}var ee,ie;function jt(e){if(ee===void 0)try{throw Error()}catch(s){var i=s.stack.trim().match(/\n( *(at )?)/);ee=i&&i[1]||"",ie=-1<s.stack.indexOf(`
    at`)?" (<anonymous>)":-1<s.stack.indexOf("@")?"@unknown:0:0":""}return`
`+ee+e+ie}var me=!1;function De(e,i){if(!e||me)return"";me=!0;var s=Error.prepareStackTrace;Error.prepareStackTrace=void 0;try{var l={DetermineComponentFrameRoot:function(){try{if(i){var xt=function(){throw Error()};if(Object.defineProperty(xt.prototype,"props",{set:function(){throw Error()}}),typeof Reflect=="object"&&Reflect.construct){try{Reflect.construct(xt,[])}catch(rt){var st=rt}Reflect.construct(e,[],xt)}else{try{xt.call()}catch(rt){st=rt}e.call(xt.prototype)}}else{try{throw Error()}catch(rt){st=rt}(xt=e())&&typeof xt.catch=="function"&&xt.catch(function(){})}}catch(rt){if(rt&&st&&typeof rt.stack=="string")return[rt.stack,st.stack]}return[null,null]}};l.DetermineComponentFrameRoot.displayName="DetermineComponentFrameRoot";var f=Object.getOwnPropertyDescriptor(l.DetermineComponentFrameRoot,"name");f&&f.configurable&&Object.defineProperty(l.DetermineComponentFrameRoot,"name",{value:"DetermineComponentFrameRoot"});var m=l.DetermineComponentFrameRoot(),b=m[0],A=m[1];if(b&&A){var I=b.split(`
`),et=A.split(`
...
#endif`,_b="gl_FragColor = linearToOutputTexel( gl_FragColor );",xb=`vec4 LinearTransferOETF( in vec4 value ) {
	return value;
}
...
`)+`
`+M,y=["#define varying in",n.glslVersion===Ev?"":"layout(location = 0) out highp vec4 pc_fragColor;",n.glslVersion===Ev?"":"#define gl_FragColor pc_fragColor","#define gl_FragDepthEXT gl_FragDepth","#define texture2D texture","#define textureCube texture","#define texture2DProj textureProj","#define texture2DLodEXT textureLod","#define texture2DProjLodEXT textureProjLod","#define textureCubeLodEXT textureLod","#define texture2DGradEXT textureGrad","#define texture2DProjGradEXT textureProjGrad","#define textureCubeGradEXT textureGrad"].join(`
`)+`
`+y);const U=L+M+u,w=L+y+h,P=p_(o,o.VERTEX_SHADER,U),O=p_(o,o.FRAGMENT_SHADER,w);o.attachShader(E,P),o.attachShader(E,O),n.index0AttributeName!==void 0?o.bindAttribLocation(E,0,n.index0AttributeName):n.morphTargets===!0&&o.bindAttribLocation(E,0,"position"),o.linkProgram(E);function F(V){if(r.debug.checkShaderErrors){const W=o.getProgramInfoLog(E)||"",nt=o.getShaderInfoLog(P)||"",ot=o.getShaderInfoLog(O)||"",ft=W.trim(),B=nt.trim(),tt=ot.trim();let Y=!0,lt=!0;if(o.getProgramParameter(E,o.LINK_STATUS)===!1)if(Y=!1,typeof r.debug.onShaderError=="function")r.debug.onShaderError(o,E,P,O);else{const N=g_(o,P,"vertex"),Z=g_(o,O,"fragment");console.error("THREE.WebGLProgram: Shader Error "+o.getError()+" - VALIDATE_STATUS "+o.getProgramParameter(E,o.VALIDATE_STATUS)+`
...
}`;function u2(r,t,n){let a=new Ep;const o=new It,c=new It,u=new Ve,h=new C1({depthPacking:cS}),d=new D1,p={},g=n.maxTextureSize,v={[ts]:ti,[ti]:ts,[Nn]:Nn},_=new mn({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new It},radius:{value:4}},vertexShader:l2,fragmentShader:c2}),x=_.clone();x.defines.HORIZONTAL_PASS=1;const S=new sn;S.setAttribute("position",new hi(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const E=new qt(S,_),M=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=pp;let y=this.type;this.render=function(O,F,G){if(M.enabled===!1||M.autoUpdate===!1&&M.needsUpdate===!1||O.length===0)return;const R=r.getRenderTarget(),D=r.getActiveCubeFace(),V=r.getActiveMipmapLevel(),W=r.state;W.setBlending(ga),W.buffers.depth.getReversed()===!0?W.buffers.color.setClear(0,0,0,0):W.buffers.color.setClear(1,1,1,1),W.buffers.depth.setTest(!0),W.setScissorTest(!1);const nt=y!==da&&this.type===da,ot=y===da&&this.type!==da;for(let ft=0,B=O.length;ft<B;ft++){const tt=O[ft],Y=tt.shadow;if(Y===void 0){console.warn("THREE.WebGLShadowMap:",tt,"has no shadow.");continue}if(Y.autoUpdate===!1&&Y.needsUpdate===!1)continue;o.copy(Y.mapSize);const lt=Y.getFrameExtents();if(o.multiply(lt),c.copy(Y.mapSize),(o.x>g||o.y>g)&&(o.x>g&&(c.x=Math.floor(g/lt.x),o.x=c.x*lt.x,Y.mapSize.x=c.x),o.y>g&&(c.y=Math.floor(g/lt.y),o.y=c.y*lt.y,Y.mapSize.y=c.y)),Y.map===null||nt===!0||ot===!0){const Z=this.type!==da?{minFilter:fi,magFilter:fi}:{};Y.map!==null&&Y.map.dispose(),Y.map=new Li(o.x,o.y,Z),Y.map.texture.name=tt.name+".shadowMap",Y.camera.updateProjectionMatrix()}r.setRenderTarget(Y.map),r.clear();const N=Y.getViewportCount();for(let Z=0;Z<N;Z++){const dt=Y.getViewport(Z);u.set(c.x*dt.x,c.y*dt.y,c.x*dt.z,c.y*dt.w),W.viewport(u),Y.updateMatrices(tt,Z),a=Y.getFrustum(),w(F,G,Y.camera,tt,this.type)}Y.isPointLightShadow!==!0&&this.type===da&&L(Y,G),Y.needsUpdate=!1}y=this.type,M.needsUpdate=!1,r.setRenderTarget(R,D,V)};function L(O,F){const G=t.update(E);_.defines.VSM_SAMPLES!==O.blurSamples&&(_.defines.VSM_SAMPLES=O.blurSamples,x.defines.VSM_SAMPLES=O.blurSamples,_.needsUpdate=!0,x.needsUpdate=!0),O.mapPass===null&&(O.mapPass=new Li(o.x,o.y)),_.uniforms.shadow_pass.value=O.map.texture,_.uniforms.resolution.value=O.mapSize,_.uniforms.radius.value=O.radius,r.setRenderTarget(O.mapPass),r.clear(),r.renderBufferDirect(F,null,G,_,E,null),x.uniforms.shadow_pass.value=O.mapPass.texture,x.uniforms.resolution.value=O.mapSize,x.uniforms.radius.value=O.radius,r.setRenderTarget(O.map),r.clear(),r.renderBufferDirect(F,null,G,x,E,null)}function U(O,F,G,R){let D=null;const V=G.isPointLight===!0?O.customDistanceMaterial:O.customDepthMaterial;if(V!==void 0)D=V;else if(D=G.isPointLight===!0?d:h,r.localClippingEnabled&&F.clipShadows===!0&&Array.isArray(F.clippingPlanes)&&F.clippingPlanes.length!==0||F.displacementMap&&F.displacementScale!==0||F.alphaMap&&F.alphaTest>0||F.map&&F.alphaTest>0||F.alphaToCoverage===!0){const W=D.uuid,nt=F.uuid;let ot=p[W];ot===void 0&&(ot={},p[W]=ot);let ft=ot[nt];ft===void 0&&(ft=D.clone(),ot[nt]=ft,F.addEventListener("dispose",P)),D=ft}if(D.visible=F.visible,D.wireframe=F.wireframe,R===da?D.side=F.shadowSide!==null?F.shadowSide:F.side:D.side=F.shadowSide!==null?F.shadowSide:v[F.side],D.alphaMap=F.alphaMap,D.alphaTest=F.alphaToCoverage===!0?.5:F.alphaTest,D.map=F.map,D.clipShadows=F.clipShadows,D.clippingPlanes=F.clippingPlanes,D.clipIntersection=F.clipIntersection,D.displacementMap=F.displacementMap,D.displacementScale=F.displacementScale,D.displacementBias=F.displacementBias,D.wireframeLinewidth=F.wireframeLinewidth,D.linewidth=F.linewidth,G.isPointLight===!0&&D.isMeshDistanceMaterial===!0){const W=r.properties.get(D);W.light=G}return D}function w(O,F,G,R,D){if(O.visible===!1)return;if(O.layers.test(F.layers)&&(O.isMesh||O.isLine||O.isPoints)&&(O.castShadow||O.receiveShadow&&D===da)&&(!O.frustumCulled||a.intersectsObject(O))){O.modelViewMatrix.multiplyMatrices(G.matrixWorldInverse,O.matrixWorld);const nt=t.update(O),ot=O.material;if(Array.isArray(ot)){const ft=nt.groups;for(let B=0,tt=ft.length;B<tt;B++){const Y=ft[B],lt=ot[Y.materialIndex];if(lt&&lt.visible){const N=U(O,lt,R,D);O.onBeforeShadow(r,O,F,G,nt,N,Y),r.renderBufferDirect(G,null,nt,N,O,Y),O.onAfterShadow(r,O,F,G,nt,N,Y)}}}else if(ot.visible){const ft=U(O,ot,R,D);O.onBeforeShadow(r,O,F,G,nt,ft,null),r.renderBufferDirect(G,null,nt,ft,O,null),O.onAfterShadow(r,O,F,G,nt,ft,null)}}const W=O.children;for(let nt=0,ot=W.length;nt<ot;nt++)w(W[nt],F,G,R,D)}function P(O){O.target.removeEventListener("dispose",P);for(const G in p){const R=p[G],D=O.target.uuid;D in R&&(R[D].dispose(),delete R[D])}}}const f2={[Md]:Sd,[bd]:Ad,[Ed]:wd,[Vr]:Td,[Sd]:Md,[Ad]:bd,[wd]:Ed,[Td]:Vr};function h2(r,t){function n(){let q=!1;const Tt=new Ve;let Ct=null;const Bt=new Ve(0,0,0,0);return{setMask:function(bt){Ct!==bt&&!q&&(r.colorMask(bt,bt,bt,bt),Ct=bt)},setLocked:function(bt){q=bt},setClear:function(bt,Mt,Vt,oe,Ne){Ne===!0&&(bt*=oe,Mt*=oe,Vt*=oe),Tt.set(bt,Mt,Vt,oe),Bt.equals(Tt)===!1&&(r.clearColor(bt,Mt,Vt,oe),Bt.copy(Tt))},reset:function(){q=!1,Ct=null,Bt.set(-1,0,0,0)}}}function a(){let q=!1,Tt=!1,Ct=null,Bt=null,bt=null;return{setReversed:function(Mt){if(Tt!==Mt){const Vt=t.get("EXT_clip_control");Mt?Vt.clipControlEXT(Vt.LOWER_LEFT_EXT,Vt.ZERO_TO_ONE_EXT):Vt.clipControlEXT(Vt.LOWER_LEFT_EXT,Vt.NEGATIVE_ONE_TO_ONE_EXT),Tt=Mt;const oe=bt;bt=null,this.setClear(oe)}},getReversed:function(){return Tt},setTest:function(Mt){Mt?yt(r.DEPTH_TEST):wt(r.DEPTH_TEST)},setMask:function(Mt){Ct!==Mt&&!q&&(r.depthMask(Mt),Ct=Mt)},setFunc:function(Mt){if(Tt&&(Mt=f2[Mt]),Bt!==Mt){switch(Mt){case Md:r.depthFunc(r.NEVER);break;case Sd:r.depthFunc(r.ALWAYS);break;case bd:r.depthFunc(r.LESS);break;case Vr:r.depthFunc(r.LEQUAL);break;case Ed:r.depthFunc(r.EQUAL);break;case Td:r.depthFunc(r.GEQUAL);break;case Ad:r.depthFunc(r.GREATER);break;case wd:r.depthFunc(r.NOTEQUAL);break;default:r.depthFunc(r.LEQUAL)}Bt=Mt}},setLocked:function(Mt){q=Mt},setClear:function(Mt){bt!==Mt&&(Tt&&(Mt=1-Mt),r.clearDepth(Mt),bt=Mt)},reset:function(){q=!1,Ct=null,Bt=null,bt=null,Tt=!1}}}function o(){let q=!1,Tt=null,Ct=null,Bt=null,bt=null,Mt=null,Vt=null,oe=null,Ne=null;return{setTest:function(we){q||(we?yt(r.STENCIL_TEST):wt(r.STENCIL_TEST))},setMask:function(we){Tt!==we&&!q&&(r.stencilMask(we),Tt=we)},setFunc:function(we,Mi,gn){(Ct!==we||Bt!==Mi||bt!==gn)&&(r.stencilFunc(we,Mi,gn),Ct=we,Bt=Mi,bt=gn)},setOp:function(we,Mi,gn){(Mt!==we||Vt!==Mi||oe!==gn)&&(r.stencilOp(we,Mi,gn),Mt=we,Vt=Mi,oe=gn)},setLocked:function(we){q=we},setClear:function(we){Ne!==we&&(r.clearStencil(we),Ne=we)},reset:function(){q=!1,Tt=null,Ct=null,Bt=null,bt=null,Mt=null,Vt=null,oe=null,Ne=null}}}const c=new n,u=new a,h=new o,d=new WeakMap,p=new WeakMap;let g={},v={},_=new WeakMap,x=[],S=null,E=!1,M=null,y=null,L=null,U=null,w=null,P=null,O=null,F=new le(0,0,0),G=0,R=!1,D=null,V=null,W=null,nt=null,ot=null;const ft=r.getParameter(r.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let B=!1,tt=0;const Y=r.getParameter(r.VERSION);Y.indexOf("WebGL")!==-1?(tt=parseFloat(/^WebGL (\d)/.exec(Y)[1]),B=tt>=1):Y.indexOf("OpenGL ES")!==-1&&(tt=parseFloat(/^OpenGL ES (\d)/.exec(Y)[1]),B=tt>=2);let lt=null,N={};const Z=r.getParameter(r.SCISSOR_BOX),dt=r.getParameter(r.VIEWPORT),vt=new Ve().fromArray(Z),At=new Ve().fromArray(dt);function Gt(q,Tt,Ct,Bt){const bt=new Uint8Array(4),Mt=r.createTexture();r.bindTexture(q,Mt),r.texParameteri(q,r.TEXTURE_MIN_FILTER,r.NEAREST),r.texParameteri(q,r.TEXTURE_MAG_FILTER,r.NEAREST);for(let Vt=0;Vt<Ct;Vt++)q===r.TEXTURE_3D||q===r.TEXTURE_2D_ARRAY?r.texImage3D(Tt,0,r.RGBA,1,1,Bt,0,r.RGBA,r.UNSIGNED_BYTE,bt):r.texImage2D(Tt+Vt,0,r.RGBA,1,1,0,r.RGBA,r.UNSIGNED_BYTE,bt);return Mt}const at={};at[r.TEXTURE_2D]=Gt(r.TEXTURE_2D,r.TEXTURE_2D,1),at[r.TEXTURE_CUBE_MAP]=Gt(r.TEXTURE_CUBE_MAP,r.TEXTURE_CUBE_MAP_POSITIVE_X,6),at[r.TEXTURE_2D_ARRAY]=Gt(r.TEXTURE_2D_ARRAY,r.TEXTURE_2D_ARRAY,1,1),at[r.TEXTURE_3D]=Gt(r.TEXTURE_3D,r.TEXTURE_3D,1,1),c.setClear(0,0,0,1),u.setClear(1),h.setClear(0),yt(r.DEPTH_TEST),u.setFunc(Vr),se(!1),Ot(xv),yt(r.CULL_FACE),Be(ga);function yt(q){g[q]!==!0&&(r.enable(q),g[q]=!0)}function wt(q){g[q]!==!1&&(r.disable(q),g[q]=!1)}function $t(q,Tt){return v[q]!==Tt?(r.bindFramebuffer(q,Tt),v[q]=Tt,q===r.DRAW_FRAMEBUFFER&&(v[r.FRAMEBUFFER]=Tt),q===r.FRAMEBUFFER&&(v[r.DRAW_FRAMEBUFFER]=Tt),!0):!1}function Zt(q,Tt){let Ct=x,Bt=!1;if(q){Ct=_.get(Tt),Ct===void 0&&(Ct=[],_.set(Tt,Ct));const bt=q.textures;if(Ct.length!==bt.length||Ct[0]!==r.COLOR_ATTACHMENT0){for(let Mt=0,Vt=bt.length;Mt<Vt;Mt++)Ct[Mt]=r.COLOR_ATTACHMENT0+Mt;Ct.length=bt.length,Bt=!0}}else Ct[0]!==r.BACK&&(Ct[0]=r.BACK,Bt=!0);Bt&&r.drawBuffers(Ct)}function _e(q){return S!==q?(r.useProgram(q),S=q,!0):!1}const un={[Ds]:r.FUNC_ADD,[VM]:r.FUNC_SUBTRACT,[kM]:r.FUNC_REVERSE_SUBTRACT};un[XM]=r.MIN,un[WM]=r.MAX;const H={[qM]:r.ZERO,[YM]:r.ONE,[jM]:r.SRC_COLOR,[xd]:r.SRC_ALPHA,[tS]:r.SRC_ALPHA_SATURATE,[JM]:r.DST_COLOR,[KM]:r.DST_ALPHA,[ZM]:r.ONE_MINUS_SRC_COLOR,[yd]:r.ONE_MINUS_SRC_ALPHA,[$M]:r.ONE_MINUS_DST_COLOR,[QM]:r.ONE_MINUS_DST_ALPHA,[eS]:r.CONSTANT_COLOR,[nS]:r.ONE_MINUS_CONSTANT_COLOR,[iS]:r.CONSTANT_ALPHA,[aS]:r.ONE_MINUS_CONSTANT_ALPHA};function Be(q,Tt,Ct,Bt,bt,Mt,Vt,oe,Ne,we){if(q===ga){E===!0&&(wt(r.BLEND),E=!1);return}if(E===!1&&(yt(r.BLEND),E=!0),q!==GM){if(q!==M||we!==R){if((y!==Ds||w!==Ds)&&(r.blendEquation(r.FUNC_ADD),y=Ds,w=Ds),we)switch(q){case Fr:r.blendFuncSeparate(r.ONE,r.ONE_MINUS_SRC_ALPHA,r.ONE,r.ONE_MINUS_SRC_ALPHA);break;case Os:r.blendFunc(r.ONE,r.ONE);break;case yv:r.blendFuncSeparate(r.ZERO,r.ONE_MINUS_SRC_COLOR,r.ZERO,r.ONE);break;case Mv:r.blendFuncSeparate(r.DST_COLOR,r.ONE_MINUS_SRC_ALPHA,r.ZERO,r.ONE);break;default:console.error("THREE.WebGLState: Invalid blending: ",q);break}else switch(q){case Fr:r.blendFuncSeparate(r.SRC_ALPHA,r.ONE_MINUS_SRC_ALPHA,r.ONE,r.ONE_MINUS_SRC_ALPHA);break;case Os:r.blendFuncSeparate(r.SRC_ALPHA,r.ONE,r.ONE,r.ONE);break;case yv:console.error("THREE.WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case Mv:console.error("THREE.WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:console.error("THREE.WebGLState: Invalid blending: ",q);break}L=null,U=null,P=null,O=null,F.set(0,0,0),G=0,M=q,R=we}return}bt=bt||Tt,Mt=Mt||Ct,Vt=Vt||Bt,(Tt!==y||bt!==w)&&(r.blendEquationSeparate(un[Tt],un[bt]),y=Tt,w=bt),(Ct!==L||Bt!==U||Mt!==P||Vt!==O)&&(r.blendFuncSeparate(H[Ct],H[Bt],H[Mt],H[Vt]),L=Ct,U=Bt,P=Mt,O=Vt),(oe.equals(F)===!1||Ne!==G)&&(r.blendColor(oe.r,oe.g,oe.b,Ne),F.copy(oe),G=Ne),M=q,R=!1}function ue(q,Tt){q.side===Nn?wt(r.CULL_FACE):yt(r.CULL_FACE);let Ct=q.side===ti;Tt&&(Ct=!Ct),se(Ct),q.blending===Fr&&q.transparent===!1?Be(ga):Be(q.blending,q.blendEquation,q.blendSrc,q.blendDst,q.blendEquationAlpha,q.blendSrcAlpha,q.blendDstAlpha,q.blendColor,q.blendAlpha,q.premultipliedAlpha),u.setFunc(q.depthFunc),u.setTest(q.depthTest),u.setMask(q.depthWrite),c.setMask(q.colorWrite);const Bt=q.stencilWrite;h.setTest(Bt),Bt&&(h.setMask(q.stencilWriteMask),h.setFunc(q.stencilFunc,q.stencilRef,q.stencilFuncMask),h.setOp(q.stencilFail,q.stencilZFail,q.stencilZPass)),kt(q.polygonOffset,q.polygonOffsetFactor,q.polygonOffsetUnits),q.alphaToCoverage===!0?yt(r.SAMPLE_ALPHA_TO_COVERAGE):wt(r.SAMPLE_ALPHA_TO_COVERAGE)}function se(q){D!==q&&(q?r.frontFace(r.CW):r.frontFace(r.CCW),D=q)}function Ot(q){q!==IM?(yt(r.CULL_FACE),q!==V&&(q===xv?r.cullFace(r.BACK):q===FM?r.cullFace(r.FRONT):r.cullFace(r.FRONT_AND_BACK))):wt(r.CULL_FACE),V=q}function qe(q){q!==W&&(B&&r.lineWidth(q),W=q)}function kt(q,Tt,Ct){q?(yt(r.POLYGON_OFFSET_FILL),(nt!==Tt||ot!==Ct)&&(r.polygonOffset(Tt,Ct),nt=Tt,ot=Ct)):wt(r.POLYGON_OFFSET_FILL)}function fe(q){q?yt(r.SCISSOR_TEST):wt(r.SCISSOR_TEST)}function Qe(q){q===void 0&&(q=r.TEXTURE0+ft-1),lt!==q&&(r.activeTexture(q),lt=q)}function Je(q,Tt,Ct){Ct===void 0&&(lt===null?Ct=r.TEXTURE0+ft-1:Ct=lt);let Bt=N[Ct];Bt===void 0&&(Bt={type:void 0,texture:void 0},N[Ct]=Bt),(Bt.type!==q||Bt.texture!==Tt)&&(lt!==Ct&&(r.activeTexture(Ct),lt=Ct),r.bindTexture(q,Tt||at[q]),Bt.type=q,Bt.texture=Tt)}function z(){const q=N[lt];q!==void 0&&q.type!==void 0&&(r.bindTexture(q.type,null),q.type=void 0,q.texture=void 0)}function T(){try{r.compressedTexImage2D(...arguments)}catch(q){console.error("THREE.WebGLState:",q)}}function it(){try{r.compressedTexImage3D(...arguments)}catch(q){console.error("THREE.WebGLState:",q)}}function pt(){try{r.texSubImage2D(...arguments)}catch(q){console.error("THREE.WebGLState:",q)}}function _t(){try{r.texSubImage3D(...arguments)}catch(q){console.error("THREE.WebGLState:",q)}}function ht(){try{r.compressedTexSubImage2D(...arguments)}catch(q){console.error("THREE.WebGLState:",q)}}function zt(){try{r.compressedTexSubImage3D(...arguments)}catch(q){console.error("THREE.WebGLState:",q)}}function Rt(){try{r.texStorage2D(...arguments)}catch(q){console.error("THREE.WebGLState:",q)}}function Yt(){try{r.texStorage3D(...arguments)}catch(q){console.error("THREE.WebGLState:",q)}}function Kt(){try{r.texImage2D(...arguments)}catch(q){console.error("THREE.WebGLState:",q)}}function St(){try{r.texImage3D(...arguments)}catch(q){console.error("THREE.WebGLState:",q)}}function Lt(q){vt.equals(q)===!1&&(r.scissor(q.x,q.y,q.z,q.w),vt.copy(q))}function Jt(q){At.equals(q)===!1&&(r.viewport(q.x,q.y,q.z,q.w),At.copy(q))}function Xt(q,Tt){let Ct=p.get(Tt);Ct===void 0&&(Ct=new WeakMap,p.set(Tt,Ct));let Bt=Ct.get(q);Bt===void 0&&(Bt=r.getUniformBlockIndex(Tt,q.name),Ct.set(q,Bt))}function Dt(q,Tt){const Bt=p.get(Tt).get(q);d.get(Tt)!==Bt&&(r.uniformBlockBinding(Tt,Bt,q.__bindingPointIndex),d.set(Tt,Bt))}function he(){r.disable(r.BLEND),r.disable(r.CULL_FACE),r.disable(r.DEPTH_TEST),r.disable(r.POLYGON_OFFSET_FILL),r.disable(r.SCISSOR_TEST),r.disable(r.STENCIL_TEST),r.disable(r.SAMPLE_ALPHA_TO_COVERAGE),r.blendEquation(r.FUNC_ADD),r.blendFunc(r.ONE,r.ZERO),r.blendFuncSeparate(r.ONE,r.ZERO,r.ONE,r.ZERO),r.blendColor(0,0,0,0),r.colorMask(!0,!0,!0,!0),r.clearColor(0,0,0,0),r.depthMask(!0),r.depthFunc(r.LESS),u.setReversed(!1),r.clearDepth(1),r.stencilMask(4294967295),r.stencilFunc(r.ALWAYS,0,4294967295),r.stencilOp(r.KEEP,r.KEEP,r.KEEP),r.clearStencil(0),r.cullFace(r.BACK),r.frontFace(r.CCW),r.polygonOffset(0,0),r.activeTexture(r.TEXTURE0),r.bindFramebuffer(r.FRAMEBUFFER,null),r.bindFramebuffer(r.DRAW_FRAMEBUFFER,null),r.bindFramebuffer(r.READ_FRAMEBUFFER,null),r.useProgram(null),r.lineWidth(1),r.scissor(0,0,r.canvas.width,r.canvas.height),r.viewport(0,0,r.canvas.width,r.canvas.height),g={},lt=null,N={},v={},_=new WeakMap,x=[],S=null,E=!1,M=null,y=null,L=null,U=null,w=null,P=null,O=null,F=new le(0,0,0),G=0,R=!1,D=null,V=null,W=null,nt=null,ot=null,vt.set(0,0,r.canvas.width,r.canvas.height),At.set(0,0,r.canvas.width,r.canvas.height),c.reset(),u.reset(),h.reset()}return{buffers:{color:c,depth:u,stencil:h},enable:yt,disable:wt,bindFramebuffer:$t,drawBuffers:Zt,useProgram:_e,setBlending:Be,setMaterial:ue,setFlipSided:se,setCullFace:Ot,setLineWidth:qe,setPolygonOffset:kt,setScissorTest:fe,activeTexture:Qe,bindTexture:Je,unbindTexture:z,compressedTexImage2D:T,compressedTexImage3D:it,texImage2D:Kt,texImage3D:St,updateUBOMapping:Xt,uniformBlockBinding:Dt,texStorage2D:Rt,texStorage3D:Yt,texSubImage2D:pt,texSubImage3D:_t,compressedTexSubImage2D:ht,compressedTexSubImage3D:zt,scissor:Lt,viewport:Jt,reset:he}}function d2(r,t,n,a,o,c,u){const h=t.has("WEBGL_multisampled_render_to_texture")?t.get("WEBGL_multisampled_render_to_texture"):null,d=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),p=new It,g=new WeakMap;let v;const _=new WeakMap;let x=!1;try{x=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function S(z,T){return x?new OffscreenCanvas(z,T):xl("canvas")}function E(z,T,it){let pt=1;const _t=Je(z);if((_t.width>it||_t.height>it)&&(pt=it/Math.max(_t.width,_t.height)),pt<1)if(typeof HTMLImageElement<"u"&&z instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&z instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&z instanceof ImageBitmap||typeof VideoFrame<"u"&&z instanceof VideoFrame){const ht=Math.floor(pt*_t.width),zt=Math.floor(pt*_t.height);v===void 0&&(v=S(ht,zt));const Rt=T?S(ht,zt):v;return Rt.width=ht,Rt.height=zt,Rt.getContext("2d").drawImage(z,0,0,ht,zt),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+_t.width+"x"+_t.height+") to ("+ht+"x"+zt+")."),Rt}else return"data"in z&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+_t.width+"x"+_t.height+")."),z;return z}function M(z){return z.generateMipmaps}function y(z){r.generateMipmap(z)}function L(z){return z.isWebGLCubeRenderTarget?r.TEXTURE_CUBE_MAP:z.isWebGL3DRenderTarget?r.TEXTURE_3D:z.isWebGLArrayRenderTarget||z.isCompressedArrayTexture?r.TEXTURE_2D_ARRAY:r.TEXTURE_2D}function U(z,T,it,pt,_t=!1){if(z!==null){if(r[z]!==void 0)return r[z];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+z+"'")}let ht=T;if(T===r.RED&&(it===r.FLOAT&&(ht=r.R32F),it===r.HALF_FLOAT&&(ht=r.R16F),it===r.UNSIGNED_BYTE&&(ht=r.R8)),T===r.RED_INTEGER&&(it===r.UNSIGNED_BYTE&&(ht=r.R8UI),it===r.UNSIGNED_SHORT&&(ht=r.R16UI),it===r.UNSIGNED_INT&&(ht=r.R32UI),it===r.BYTE&&(ht=r.R8I),it===r.SHORT&&(ht=r.R16I),it===r.INT&&(ht=r.R32I)),T===r.RG&&(it===r.FLOAT&&(ht=r.RG32F),it===r.HALF_FLOAT&&(ht=r.RG16F),it===r.UNSIGNED_BYTE&&(ht=r.RG8)),T===r.RG_INTEGER&&(it===r.UNSIGNED_BYTE&&(ht=r.RG8UI),it===r.UNSIGNED_SHORT&&(ht=r.RG16UI),it===r.UNSIGNED_INT&&(ht=r.RG32UI),it===r.BYTE&&(ht=r.RG8I),it===r.SHORT&&(ht=r.RG16I),it===r.INT&&(ht=r.RG32I)),T===r.RGB_INTEGER&&(it===r.UNSIGNED_BYTE&&(ht=r.RGB8UI),it===r.UNSIGNED_SHORT&&(ht=r.RGB16UI),it===r.UNSIGNED_INT&&(ht=r.RGB32UI),it===r.BYTE&&(ht=r.RGB8I),it===r.SHORT&&(ht=r.RGB16I),it===r.INT&&(ht=r.RGB32I)),T===r.RGBA_INTEGER&&(it===r.UNSIGNED_BYTE&&(ht=r.RGBA8UI),it===r.UNSIGNED_SHORT&&(ht=r.RGBA16UI),it===r.UNSIGNED_INT&&(ht=r.RGBA32UI),it===r.BYTE&&(ht=r.RGBA8I),it===r.SHORT&&(ht=r.RGBA16I),it===r.INT&&(ht=r.RGBA32I)),T===r.RGB&&(it===r.UNSIGNED_INT_5_9_9_9_REV&&(ht=r.RGB9_E5),it===r.UNSIGNED_INT_10F_11F_11F_REV&&(ht=r.R11F_G11F_B10F)),T===r.RGBA){const zt=_t?_u:Ce.getTransfer(pt);it===r.FLOAT&&(ht=r.RGBA32F),it===r.HALF_FLOAT&&(ht=r.RGBA16F),it===r.UNSIGNED_BYTE&&(ht=zt===ze?r.SRGB8_ALPHA8:r.RGBA8),it===r.UNSIGNED_SHORT_4_4_4_4&&(ht=r.RGBA4),it===r.UNSIGNED_SHORT_5_5_5_1&&(ht=r.RGB5_A1)}return(ht===r.R16F||ht===r.R32F||ht===r.RG16F||ht===r.RG32F||ht===r.RGBA16F||ht===r.RGBA32F)&&t.get("EXT_color_buffer_float"),ht}function w(z,T){let it;return z?T===null||T===zs||T===gl?it=r.DEPTH24_STENCIL8:T===ki?it=r.DEPTH32F_STENCIL8:T===ml&&(it=r.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):T===null||T===zs||T===gl?it=r.DEPTH_COMPONENT24:T===ki?it=r.DEPTH_COMPONENT32F:T===ml&&(it=r.DEPTH_COMPONENT16),it}function P(z,T){return M(z)===!0||z.isFramebufferTexture&&z.minFilter!==fi&&z.minFilter!==Di?Math.log2(Math.max(T.width,T.height))+1:z.mipmaps!==void 0&&z.mipmaps.length>0?z.mipmaps.length:z.isCompressedTexture&&Array.isArray(z.image)?T.mipmaps.length:1}function O(z){const T=z.target;T.removeEventListener("dispose",O),G(T),T.isVideoTexture&&g.delete(T)}function F(z){const T=z.target;T.removeEventListener("dispose",F),D(T)}function G(z){const T=a.get(z);if(T.__webglInit===void 0)return;const it=z.source,pt=_.get(it);if(pt){const _t=pt[T.__cacheKey];_t.usedTimes--,_t.usedTimes===0&&R(z),Object.keys(pt).length===0&&_.delete(it)}a.remove(z)}function R(z){const T=a.get(z);r.deleteTexture(T.__webglTexture);const it=z.source,pt=_.get(it);delete pt[T.__cacheKey],u.memory.textures--}function D(z){const T=a.get(z);if(z.depthTexture&&(z.depthTexture.dispose(),a.remove(z.depthTexture)),z.isWebGLCubeRenderTarget)for(let pt=0;pt<6;pt++){if(Array.isArray(T.__webglFramebuffer[pt]))for(let _t=0;_t<T.__webglFramebuffer[pt].length;_t++)r.deleteFramebuffer(T.__webglFramebuffer[pt][_t]);else r.deleteFramebuffer(T.__webglFramebuffer[pt]);T.__webglDepthbuffer&&r.deleteRenderbuffer(T.__webglDepthbuffer[pt])}else{if(Array.isArray(T.__webglFramebuffer))for(let pt=0;pt<T.__webglFramebuffer.length;pt++)r.deleteFramebuffer(T.__webglFramebuffer[pt]);else r.deleteFramebuffer(T.__webglFramebuffer);if(T.__webglDepthbuffer&&r.deleteRenderbuffer(T.__webglDepthbuffer),T.__webglMultisampledFramebuffer&&r.deleteFramebuffer(T.__webglMultisampledFramebuffer),T.__webglColorRenderbuffer)for(let pt=0;pt<T.__webglColorRenderbuffer.length;pt++)T.__webglColorRenderbuffer[pt]&&r.deleteRenderbuffer(T.__webglColorRenderbuffer[pt]);T.__webglDepthRenderbuffer&&r.deleteRenderbuffer(T.__webglDepthRenderbuffer)}const it=z.textures;for(let pt=0,_t=it.length;pt<_t;pt++){const ht=a.get(it[pt]);ht.__webglTexture&&(r.deleteTexture(ht.__webglTexture),u.memory.textures--),a.remove(it[pt])}a.remove(z)}let V=0;function W(){V=0}function nt(){const z=V;return z>=o.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+z+" texture units while this GPU supports only "+o.maxTextures),V+=1,z}function ot(z){const T=[];return T.push(z.wrapS),T.push(z.wrapT),T.push(z.wrapR||0),T.push(z.magFilter),T.push(z.minFilter),T.push(z.anisotropy),T.push(z.internalFormat),T.push(z.format),T.push(z.type),T.push(z.generateMipmaps),T.push(z.premultiplyAlpha),T.push(z.flipY),T.push(z.unpackAlignment),T.push(z.colorSpace),T.join()}function ft(z,T){const it=a.get(z);if(z.isVideoTexture&&fe(z),z.isRenderTargetTexture===!1&&z.isExternalTexture!==!0&&z.version>0&&it.__version!==z.version){const pt=z.image;if(pt===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(pt.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{at(it,z,T);return}}else z.isExternalTexture&&(it.__webglTexture=z.sourceTexture?z.sourceTexture:null);n.bindTexture(r.TEXTURE_2D,it.__webglTexture,r.TEXTURE0+T)}function B(z,T){const it=a.get(z);if(z.isRenderTargetTexture===!1&&z.version>0&&it.__version!==z.version){at(it,z,T);return}n.bindTexture(r.TEXTURE_2D_ARRAY,it.__webglTexture,r.TEXTURE0+T)}function tt(z,T){const it=a.get(z);if(z.isRenderTargetTexture===!1&&z.version>0&&it.__version!==z.version){at(it,z,T);return}n.bindTexture(r.TEXTURE_3D,it.__webglTexture,r.TEXTURE0+T)}function Y(z,T){const it=a.get(z);if(z.version>0&&it.__version!==z.version){yt(it,z,T);return}n.bindTexture(r.TEXTURE_CUBE_MAP,it.__webglTexture,r.TEXTURE0+T)}const lt={[vu]:r.REPEAT,[Ls]:r.CLAMP_TO_EDGE,[Dd]:r.MIRRORED_REPEAT},N={[fi]:r.NEAREST,[oS]:r.NEAREST_MIPMAP_NEAREST,[Lc]:r.NEAREST_MIPMAP_LINEAR,[Di]:r.LINEAR,[zh]:r.LINEAR_MIPMAP_NEAREST,[Qa]:r.LINEAR_MIPMAP_LINEAR},Z={[fS]:r.NEVER,[vS]:r.ALWAYS,[hS]:r.LESS,[J_]:r.LEQUAL,[dS]:r.EQUAL,[gS]:r.GEQUAL,[pS]:r.GREATER,[mS]:r.NOTEQUAL};function dt(z,T){if(T.type===ki&&t.has("OES_texture_float_linear")===!1&&(T.magFilter===Di||T.magFilter===zh||T.magFilter===Lc||T.magFilter===Qa||T.minFilter===Di||T.minFilter===zh||T.minFilter===Lc||T.minFilter===Qa)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),r.texParameteri(z,r.TEXTURE_WRAP_S,lt[T.wrapS]),r.texParameteri(z,r.TEXTURE_WRAP_T,lt[T.wrapT]),(z===r.TEXTURE_3D||z===r.TEXTURE_2D_ARRAY)&&r.texParameteri(z,r.TEXTURE_WRAP_R,lt[T.wrapR]),r.texParameteri(z,r.TEXTURE_MAG_FILTER,N[T.magFilter]),r.texParameteri(z,r.TEXTURE_MIN_FILTER,N[T.minFilter]),T.compareFunction&&(r.texParameteri(z,r.TEXTURE_COMPARE_MODE,r.COMPARE_REF_TO_TEXTURE),r.texParameteri(z,r.TEXTURE_COMPARE_FUNC,Z[T.compareFunction])),t.has("EXT_texture_filter_anisotropic")===!0){if(T.magFilter===fi||T.minFilter!==Lc&&T.minFilter!==Qa||T.type===ki&&t.has("OES_texture_float_linear")===!1)return;if(T.anisotropy>1||a.get(T).__currentAnisotropy){const it=t.get("EXT_texture_filter_anisotropic");r.texParameterf(z,it.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(T.anisotropy,o.getMaxAnisotropy())),a.get(T).__currentAnisotropy=T.anisotropy}}}function vt(z,T){let it=!1;z.__webglInit===void 0&&(z.__webglInit=!0,T.addEventListener("dispose",O));const pt=T.source;let _t=_.get(pt);_t===void 0&&(_t={},_.set(pt,_t));const ht=ot(T);if(ht!==z.__cacheKey){_t[ht]===void 0&&(_t[ht]={texture:r.createTexture(),usedTimes:0},u.memory.textures++,it=!0),_t[ht].usedTimes++;const zt=_t[z.__cacheKey];zt!==void 0&&(_t[z.__cacheKey].usedTimes--,zt.usedTimes===0&&R(T)),z.__cacheKey=ht,z.__webglTexture=_t[ht].texture}return it}function At(z,T,it){return Math.floor(Math.floor(z/it)/T)}function Gt(z,T,it,pt){const ht=z.updateRanges;if(ht.length===0)n.texSubImage2D(r.TEXTURE_2D,0,0,0,T.width,T.height,it,pt,T.data);else{ht.sort((St,Lt)=>St.start-Lt.start);let zt=0;for(let St=1;St<ht.length;St++){const Lt=ht[zt],Jt=ht[St],Xt=Lt.start+Lt.count,Dt=At(Jt.start,T.width,4),he=At(Lt.start,T.width,4);Jt.start<=Xt+1&&Dt===he&&At(Jt.start+Jt.count-1,T.width,4)===Dt?Lt.count=Math.max(Lt.count,Jt.start+Jt.count-Lt.start):(++zt,ht[zt]=Jt)}ht.length=zt+1;const Rt=r.getParameter(r.UNPACK_ROW_LENGTH),Yt=r.getParameter(r.UNPACK_SKIP_PIXELS),Kt=r.getParameter(r.UNPACK_SKIP_ROWS);r.pixelStorei(r.UNPACK_ROW_LENGTH,T.width);for(let St=0,Lt=ht.length;St<Lt;St++){const Jt=ht[St],Xt=Math.floor(Jt.start/4),Dt=Math.ceil(Jt.count/4),he=Xt%T.width,q=Math.floor(Xt/T.width),Tt=Dt,Ct=1;r.pixelStorei(r.UNPACK_SKIP_PIXELS,he),r.pixelStorei(r.UNPACK_SKIP_ROWS,q),n.texSubImage2D(r.TEXTURE_2D,0,he,q,Tt,Ct,it,pt,T.data)}z.clearUpdateRanges(),r.pixelStorei(r.UNPACK_ROW_LENGTH,Rt),r.pixelStorei(r.UNPACK_SKIP_PIXELS,Yt),r.pixelStorei(r.UNPACK_SKIP_ROWS,Kt)}}function at(z,T,it){let pt=r.TEXTURE_2D;(T.isDataArrayTexture||T.isCompressedArrayTexture)&&(pt=r.TEXTURE_2D_ARRAY),T.isData3DTexture&&(pt=r.TEXTURE_3D);const _t=vt(z,T),ht=T.source;n.bindTexture(pt,z.__webglTexture,r.TEXTURE0+it);const zt=a.get(ht);if(ht.version!==zt.__version||_t===!0){n.activeTexture(r.TEXTURE0+it);const Rt=Ce.getPrimaries(Ce.workingColorSpace),Yt=T.colorSpace===pa?null:Ce.getPrimaries(T.colorSpace),Kt=T.colorSpace===pa||Rt===Yt?r.NONE:r.BROWSER_DEFAULT_WEBGL;r.pixelStorei(r.UNPACK_FLIP_Y_WEBGL,T.flipY),r.pixelStorei(r.UNPACK_PREMULTIPLY_ALPHA_WEBGL,T.premultiplyAlpha),r.pixelStorei(r.UNPACK_ALIGNMENT,T.unpackAlignment),r.pixelStorei(r.UNPACK_COLORSPACE_CONVERSION_WEBGL,Kt);let St=E(T.image,!1,o.maxTextureSize);St=Qe(T,St);const Lt=c.convert(T.format,T.colorSpace),Jt=c.convert(T.type);let Xt=U(T.internalFormat,Lt,Jt,T.colorSpace,T.isVideoTexture);dt(pt,T);let Dt;const he=T.mipmaps,q=T.isVideoTexture!==!0,Tt=zt.__version===void 0||_t===!0,Ct=ht.dataReady,Bt=P(T,St);if(T.isDepthTexture)Xt=w(T.format===_l,T.type),Tt&&(q?n.texStorage2D(r.TEXTURE_2D,1,Xt,St.width,St.height):n.texImage2D(r.TEXTURE_2D,0,Xt,St.width,St.height,0,Lt,Jt,null));else if(T.isDataTexture)if(he.length>0){q&&Tt&&n.texStorage2D(r.TEXTURE_2D,Bt,Xt,he[0].width,he[0].height);for(let bt=0,Mt=he.length;bt<Mt;bt++)Dt=he[bt],q?Ct&&n.texSubImage2D(r.TEXTURE_2D,bt,0,0,Dt.width,Dt.height,Lt,Jt,Dt.data):n.texImage2D(r.TEXTURE_2D,bt,Xt,Dt.width,Dt.height,0,Lt,Jt,Dt.data);T.generateMipmaps=!1}else q?(Tt&&n.texStorage2D(r.TEXTURE_2D,Bt,Xt,St.width,St.height),Ct&&Gt(T,St,Lt,Jt)):n.texImage2D(r.TEXTURE_2D,0,Xt,St.width,St.height,0,Lt,Jt,St.data);else if(T.isCompressedTexture)if(T.isCompressedArrayTexture){q&&Tt&&n.texStorage3D(r.TEXTURE_2D_ARRAY,Bt,Xt,he[0].width,he[0].height,St.depth);for(let bt=0,Mt=he.length;bt<Mt;bt++)if(Dt=he[bt],T.format!==Ui)if(Lt!==null)if(q){if(Ct)if(T.layerUpdates.size>0){const Vt=$v(Dt.width,Dt.height,T.format,T.type);for(const oe of T.layerUpdates){const Ne=Dt.data.subarray(oe*Vt/Dt.data.BYTES_PER_ELEMENT,(oe+1)*Vt/Dt.data.BYTES_PER_ELEMENT);n.compressedTexSubImage3D(r.TEXTURE_2D_ARRAY,bt,0,0,oe,Dt.width,Dt.height,1,Lt,Ne)}T.clearLayerUpdates()}else n.compressedTexSubImage3D(r.TEXTURE_2D_ARRAY,bt,0,0,0,Dt.width,Dt.height,St.depth,Lt,Dt.data)}else n.compressedTexImage3D(r.TEXTURE_2D_ARRAY,bt,Xt,Dt.width,Dt.height,St.depth,0,Dt.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else q?Ct&&n.texSubImage3D(r.TEXTURE_2D_ARRAY,bt,0,0,0,Dt.width,Dt.height,St.depth,Lt,Jt,Dt.data):n.texImage3D(r.TEXTURE_2D_ARRAY,bt,Xt,Dt.width,Dt.height,St.depth,0,Lt,Jt,Dt.data)}else{q&&Tt&&n.texStorage2D(r.TEXTURE_2D,Bt,Xt,he[0].width,he[0].height);for(let bt=0,Mt=he.length;bt<Mt;bt++)Dt=he[bt],T.format!==Ui?Lt!==null?q?Ct&&n.compressedTexSubImage2D(r.TEXTURE_2D,bt,0,0,Dt.width,Dt.height,Lt,Dt.data):n.compressedTexImage2D(r.TEXTURE_2D,bt,Xt,Dt.width,Dt.height,0,Dt.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):q?Ct&&n.texSubImage2D(r.TEXTURE_2D,bt,0,0,Dt.width,Dt.height,Lt,Jt,Dt.data):n.texImage2D(r.TEXTURE_2D,bt,Xt,Dt.width,Dt.height,0,Lt,Jt,Dt.data)}else if(T.isDataArrayTexture)if(q){if(Tt&&n.texStorage3D(r.TEXTURE_2D_ARRAY,Bt,Xt,St.width,St.height,St.depth),Ct)if(T.layerUpdates.size>0){const bt=$v(St.width,St.height,T.format,T.type);for(const Mt of T.layerUpdates){const Vt=St.data.subarray(Mt*bt/St.data.BYTES_PER_ELEMENT,(Mt+1)*bt/St.data.BYTES_PER_ELEMENT);n.texSubImage3D(r.TEXTURE_2D_ARRAY,0,0,0,Mt,St.width,St.height,1,Lt,Jt,Vt)}T.clearLayerUpdates()}else n.texSubImage3D(r.TEXTURE_2D_ARRAY,0,0,0,0,St.width,St.height,St.depth,Lt,Jt,St.data)}else n.texImage3D(r.TEXTURE_2D_ARRAY,0,Xt,St.width,St.height,St.depth,0,Lt,Jt,St.data);else if(T.isData3DTexture)q?(Tt&&n.texStorage3D(r.TEXTURE_3D,Bt,Xt,St.width,St.height,St.depth),Ct&&n.texSubImage3D(r.TEXTURE_3D,0,0,0,0,St.width,St.height,St.depth,Lt,Jt,St.data)):n.texImage3D(r.TEXTURE_3D,0,Xt,St.width,St.height,St.depth,0,Lt,Jt,St.data);else if(T.isFramebufferTexture){if(Tt)if(q)n.texStorage2D(r.TEXTURE_2D,Bt,Xt,St.width,St.height);else{let bt=St.width,Mt=St.height;for(let Vt=0;Vt<Bt;Vt++)n.texImage2D(r.TEXTURE_2D,Vt,Xt,bt,Mt,0,Lt,Jt,null),bt>>=1,Mt>>=1}}else if(he.length>0){if(q&&Tt){const bt=Je(he[0]);n.texStorage2D(r.TEXTURE_2D,Bt,Xt,bt.width,bt.height)}for(let bt=0,Mt=he.length;bt<Mt;bt++)Dt=he[bt],q?Ct&&n.texSubImage2D(r.TEXTURE_2D,bt,0,0,Lt,Jt,Dt):n.texImage2D(r.TEXTURE_2D,bt,Xt,Lt,Jt,Dt);T.generateMipmaps=!1}else if(q){if(Tt){const bt=Je(St);n.texStorage2D(r.TEXTURE_2D,Bt,Xt,bt.width,bt.height)}Ct&&n.texSubImage2D(r.TEXTURE_2D,0,0,0,Lt,Jt,St)}else n.texImage2D(r.TEXTURE_2D,0,Xt,Lt,Jt,St);M(T)&&y(pt),zt.__version=ht.version,T.onUpdate&&T.onUpdate(T)}z.__version=T.version}function yt(z,T,it){if(T.image.length!==6)return;const pt=vt(z,T),_t=T.source;n.bindTexture(r.TEXTURE_CUBE_MAP,z.__webglTexture,r.TEXTURE0+it);const ht=a.get(_t);if(_t.version!==ht.__version||pt===!0){n.activeTexture(r.TEXTURE0+it);const zt=Ce.getPrimaries(Ce.workingColorSpace),Rt=T.colorSpace===pa?null:Ce.getPrimaries(T.colorSpace),Yt=T.colorSpace===pa||zt===Rt?r.NONE:r.BROWSER_DEFAULT_WEBGL;r.pixelStorei(r.UNPACK_FLIP_Y_WEBGL,T.flipY),r.pixelStorei(r.UNPACK_PREMULTIPLY_ALPHA_WEBGL,T.premultiplyAlpha),r.pixelStorei(r.UNPACK_ALIGNMENT,T.unpackAlignment),r.pixelStorei(r.UNPACK_COLORSPACE_CONVERSION_WEBGL,Yt);const Kt=T.isCompressedTexture||T.image[0].isCompressedTexture,St=T.image[0]&&T.image[0].isDataTexture,Lt=[];for(let Mt=0;Mt<6;Mt++)!Kt&&!St?Lt[Mt]=E(T.image[Mt],!0,o.maxCubemapSize):Lt[Mt]=St?T.image[Mt].image:T.image[Mt],Lt[Mt]=Qe(T,Lt[Mt]);const Jt=Lt[0],Xt=c.convert(T.format,T.colorSpace),Dt=c.convert(T.type),he=U(T.internalFormat,Xt,Dt,T.colorSpace),q=T.isVideoTexture!==!0,Tt=ht.__version===void 0||pt===!0,Ct=_t.dataReady;let Bt=P(T,Jt);dt(r.TEXTURE_CUBE_MAP,T);let bt;if(Kt){q&&Tt&&n.texStorage2D(r.TEXTURE_CUBE_MAP,Bt,he,Jt.width,Jt.height);for(let Mt=0;Mt<6;Mt++){bt=Lt[Mt].mipmaps;for(let Vt=0;Vt<bt.length;Vt++){const oe=bt[Vt];T.format!==Ui?Xt!==null?q?Ct&&n.compressedTexSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+Mt,Vt,0,0,oe.width,oe.height,Xt,oe.data):n.compressedTexImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+Mt,Vt,he,oe.width,oe.height,0,oe.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):q?Ct&&n.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+Mt,Vt,0,0,oe.width,oe.height,Xt,Dt,oe.data):n.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+Mt,Vt,he,oe.width,oe.height,0,Xt,Dt,oe.data)}}}else{if(bt=T.mipmaps,q&&Tt){bt.length>0&&Bt++;const Mt=Je(Lt[0]);n.texStorage2D(r.TEXTURE_CUBE_MAP,Bt,he,Mt.width,Mt.height)}for(let Mt=0;Mt<6;Mt++)if(St){q?Ct&&n.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+Mt,0,0,0,Lt[Mt].width,Lt[Mt].height,Xt,Dt,Lt[Mt].data):n.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+Mt,0,he,Lt[Mt].width,Lt[Mt].height,0,Xt,Dt,Lt[Mt].data);for(let Vt=0;Vt<bt.length;Vt++){const Ne=bt[Vt].image[Mt].image;q?Ct&&n.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+Mt,Vt+1,0,0,Ne.width,Ne.height,Xt,Dt,Ne.data):n.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+Mt,Vt+1,he,Ne.width,Ne.height,0,Xt,Dt,Ne.data)}}else{q?Ct&&n.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+Mt,0,0,0,Xt,Dt,Lt[Mt]):n.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+Mt,0,he,Xt,Dt,Lt[Mt]);for(let Vt=0;Vt<bt.length;Vt++){const oe=bt[Vt];q?Ct&&n.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+Mt,Vt+1,0,0,Xt,Dt,oe.image[Mt]):n.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+Mt,Vt+1,he,Xt,Dt,oe.image[Mt])}}}M(T)&&y(r.TEXTURE_CUBE_MAP),ht.__version=_t.version,T.onUpdate&&T.onUpdate(T)}z.__version=T.version}function wt(z,T,it,pt,_t,ht){const zt=c.convert(it.format,it.colorSpace),Rt=c.convert(it.type),Yt=U(it.internalFormat,zt,Rt,it.colorSpace),Kt=a.get(T),St=a.get(it);if(St.__renderTarget=T,!Kt.__hasExternalTextures){const Lt=Math.max(1,T.width>>ht),Jt=Math.max(1,T.height>>ht);_t===r.TEXTURE_3D||_t===r.TEXTURE_2D_ARRAY?n.texImage3D(_t,ht,Yt,Lt,Jt,T.depth,0,zt,Rt,null):n.texImage2D(_t,ht,Yt,Lt,Jt,0,zt,Rt,null)}n.bindFramebuffer(r.FRAMEBUFFER,z),kt(T)?h.framebufferTexture2DMultisampleEXT(r.FRAMEBUFFER,pt,_t,St.__webglTexture,0,qe(T)):(_t===r.TEXTURE_2D||_t>=r.TEXTURE_CUBE_MAP_POSITIVE_X&&_t<=r.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&r.framebufferTexture2D(r.FRAMEBUFFER,pt,_t,St.__webglTexture,ht),n.bindFramebuffer(r.FRAMEBUFFER,null)}function $t(z,T,it){if(r.bindRenderbuffer(r.RENDERBUFFER,z),T.depthBuffer){const pt=T.depthTexture,_t=pt&&pt.isDepthTexture?pt.type:null,ht=w(T.stencilBuffer,_t),zt=T.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT,Rt=qe(T);kt(T)?h.renderbufferStorageMultisampleEXT(r.RENDERBUFFER,Rt,ht,T.width,T.height):it?r.renderbufferStorageMultisample(r.RENDERBUFFER,Rt,ht,T.width,T.height):r.renderbufferStorage(r.RENDERBUFFER,ht,T.width,T.height),r.framebufferRenderbuffer(r.FRAMEBUFFER,zt,r.RENDERBUFFER,z)}else{const pt=T.textures;for(let _t=0;_t<pt.length;_t++){const ht=pt[_t],zt=c.convert(ht.format,ht.colorSpace),Rt=c.convert(ht.type),Yt=U(ht.internalFormat,zt,Rt,ht.colorSpace),Kt=qe(T);it&&kt(T)===!1?r.renderbufferStorageMultisample(r.RENDERBUFFER,Kt,Yt,T.width,T.height):kt(T)?h.renderbufferStorageMultisampleEXT(r.RENDERBUFFER,Kt,Yt,T.width,T.height):r.renderbufferStorage(r.RENDERBUFFER,Yt,T.width,T.height)}}r.bindRenderbuffer(r.RENDERBUFFER,null)}function Zt(z,T){if(T&&T.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(n.bindFramebuffer(r.FRAMEBUFFER,z),!(T.depthTexture&&T.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const pt=a.get(T.depthTexture);pt.__renderTarget=T,(!pt.__webglTexture||T.depthTexture.image.width!==T.width||T.depthTexture.image.height!==T.height)&&(T.depthTexture.image.width=T.width,T.depthTexture.image.height=T.height,T.depthTexture.needsUpdate=!0),ft(T.depthTexture,0);const _t=pt.__webglTexture,ht=qe(T);if(T.depthTexture.format===vl)kt(T)?h.framebufferTexture2DMultisampleEXT(r.FRAMEBUFFER,r.DEPTH_ATTACHMENT,r.TEXTURE_2D,_t,0,ht):r.framebufferTexture2D(r.FRAMEBUFFER,r.DEPTH_ATTACHMENT,r.TEXTURE_2D,_t,0);else if(T.depthTexture.format===_l)kt(T)?h.framebufferTexture2DMultisampleEXT(r.FRAMEBUFFER,r.DEPTH_STENCIL_ATTACHMENT,r.TEXTURE_2D,_t,0,ht):r.framebufferTexture2D(r.FRAMEBUFFER,r.DEPTH_STENCIL_ATTACHMENT,r.TEXTURE_2D,_t,0);else throw new Error("Unknown depthTexture format")}function _e(z){const T=a.get(z),it=z.isWebGLCubeRenderTarget===!0;if(T.__boundDepthTexture!==z.depthTexture){const pt=z.depthTexture;if(T.__depthDisposeCallback&&T.__depthDisposeCallback(),pt){const _t=()=>{delete T.__boundDepthTexture,delete T.__depthDisposeCallback,pt.removeEventListener("dispose",_t)};pt.addEventListener("dispose",_t),T.__depthDisposeCallback=_t}T.__boundDepthTexture=pt}if(z.depthTexture&&!T.__autoAllocateDepthBuffer){if(it)throw new Error("target.depthTexture not supported in Cube render targets");const pt=z.texture.mipmaps;pt&&pt.length>0?Zt(T.__webglFramebuffer[0],z):Zt(T.__webglFramebuffer,z)}else if(it){T.__webglDepthbuffer=[];for(let pt=0;pt<6;pt++)if(n.bindFramebuffer(r.FRAMEBUFFER,T.__webglFramebuffer[pt]),T.__webglDepthbuffer[pt]===void 0)T.__webglDepthbuffer[pt]=r.createRenderbuffer(),$t(T.__webglDepthbuffer[pt],z,!1);else{const _t=z.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT,ht=T.__webglDepthbuffer[pt];r.bindRenderbuffer(r.RENDERBUFFER,ht),r.framebufferRenderbuffer(r.FRAMEBUFFER,_t,r.RENDERBUFFER,ht)}}else{const pt=z.texture.mipmaps;if(pt&&pt.length>0?n.bindFramebuffer(r.FRAMEBUFFER,T.__webglFramebuffer[0]):n.bindFramebuffer(r.FRAMEBUFFER,T.__webglFramebuffer),T.__webglDepthbuffer===void 0)T.__webglDepthbuffer=r.createRenderbuffer(),$t(T.__webglDepthbuffer,z,!1);else{const _t=z.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT,ht=T.__webglDepthbuffer;r.bindRenderbuffer(r.RENDERBUFFER,ht),r.framebufferRenderbuffer(r.FRAMEBUFFER,_t,r.RENDERBUFFER,ht)}}n.bindFramebuffer(r.FRAMEBUFFER,null)}function un(z,T,it){const pt=a.get(z);T!==void 0&&wt(pt.__webglFramebuffer,z,z.texture,r.COLOR_ATTACHMENT0,r.TEXTURE_2D,0),it!==void 0&&_e(z)}function H(z){const T=z.texture,it=a.get(z),pt=a.get(T);z.addEventListener("dispose",F);const _t=z.textures,ht=z.isWebGLCubeRenderTarget===!0,zt=_t.length>1;if(zt||(pt.__webglTexture===void 0&&(pt.__webglTexture=r.createTexture()),pt.__version=T.version,u.memory.textures++),ht){it.__webglFramebuffer=[];for(let Rt=0;Rt<6;Rt++)if(T.mipmaps&&T.mipmaps.length>0){it.__webglFramebuffer[Rt]=[];for(let Yt=0;Yt<T.mipmaps.length;Yt++)it.__webglFramebuffer[Rt][Yt]=r.createFramebuffer()}else it.__webglFramebuffer[Rt]=r.createFramebuffer()}else{if(T.mipmaps&&T.mipmaps.length>0){it.__webglFramebuffer=[];for(let Rt=0;Rt<T.mipmaps.length;Rt++)it.__webglFramebuffer[Rt]=r.createFramebuffer()}else it.__webglFramebuffer=r.createFramebuffer();if(zt)for(let Rt=0,Yt=_t.length;Rt<Yt;Rt++){const Kt=a.get(_t[Rt]);Kt.__webglTexture===void 0&&(Kt.__webglTexture=r.createTexture(),u.memory.textures++)}if(z.samples>0&&kt(z)===!1){it.__webglMultisampledFramebuffer=r.createFramebuffer(),it.__webglColorRenderbuffer=[],n.bindFramebuffer(r.FRAMEBUFFER,it.__webglMultisampledFramebuffer);for(let Rt=0;Rt<_t.length;Rt++){const Yt=_t[Rt];it.__webglColorRenderbuffer[Rt]=r.createRenderbuffer(),r.bindRenderbuffer(r.RENDERBUFFER,it.__webglColorRenderbuffer[Rt]);const Kt=c.convert(Yt.format,Yt.colorSpace),St=c.convert(Yt.type),Lt=U(Yt.internalFormat,Kt,St,Yt.colorSpace,z.isXRRenderTarget===!0),Jt=qe(z);r.renderbufferStorageMultisample(r.RENDERBUFFER,Jt,Lt,z.width,z.height),r.framebufferRenderbuffer(r.FRAMEBUFFER,r.COLOR_ATTACHMENT0+Rt,r.RENDERBUFFER,it.__webglColorRenderbuffer[Rt])}r.bindRenderbuffer(r.RENDERBUFFER,null),z.depthBuffer&&(it.__webglDepthRenderbuffer=r.createRenderbuffer(),$t(it.__webglDepthRenderbuffer,z,!0)),n.bindFramebuffer(r.FRAMEBUFFER,null)}}if(ht){n.bindTexture(r.TEXTURE_CUBE_MAP,pt.__webglTexture),dt(r.TEXTURE_CUBE_MAP,T);for(let Rt=0;Rt<6;Rt++)if(T.mipmaps&&T.mipmaps.length>0)for(let Yt=0;Yt<T.mipmaps.length;Yt++)wt(it.__webglFramebuffer[Rt][Yt],z,T,r.COLOR_ATTACHMENT0,r.TEXTURE_CUBE_MAP_POSITIVE_X+Rt,Yt);else wt(it.__webglFramebuffer[Rt],z,T,r.COLOR_ATTACHMENT0,r.TEXTURE_CUBE_MAP_POSITIVE_X+Rt,0);M(T)&&y(r.TEXTURE_CUBE_MAP),n.unbindTexture()}else if(zt){for(let Rt=0,Yt=_t.length;Rt<Yt;Rt++){const Kt=_t[Rt],St=a.get(Kt);let Lt=r.TEXTURE_2D;(z.isWebGL3DRenderTarget||z.isWebGLArrayRenderTarget)&&(Lt=z.isWebGL3DRenderTarget?r.TEXTURE_3D:r.TEXTURE_2D_ARRAY),n.bindTexture(Lt,St.__webglTexture),dt(Lt,Kt),wt(it.__webglFramebuffer,z,Kt,r.COLOR_ATTACHMENT0+Rt,Lt,0),M(Kt)&&y(Lt)}n.unbindTexture()}else{let Rt=r.TEXTURE_2D;if((z.isWebGL3DRenderTarget||z.isWebGLArrayRenderTarget)&&(Rt=z.isWebGL3DRenderTarget?r.TEXTURE_3D:r.TEXTURE_2D_ARRAY),n.bindTexture(Rt,pt.__webglTexture),dt(Rt,T),T.mipmaps&&T.mipmaps.length>0)for(let Yt=0;Yt<T.mipmaps.length;Yt++)wt(it.__webglFramebuffer[Yt],z,T,r.COLOR_ATTACHMENT0,Rt,Yt);else wt(it.__webglFramebuffer,z,T,r.COLOR_ATTACHMENT0,Rt,0);M(T)&&y(Rt),n.unbindTexture()}z.depthBuffer&&_e(z)}function Be(z){const T=z.textures;for(let it=0,pt=T.length;it<pt;it++){const _t=T[it];if(M(_t)){const ht=L(z),zt=a.get(_t).__webglTexture;n.bindTexture(ht,zt),y(ht),n.unbindTexture()}}}const ue=[],se=[];function Ot(z){if(z.samples>0){if(kt(z)===!1){const T=z.textures,it=z.width,pt=z.height;let _t=r.COLOR_BUFFER_BIT;const ht=z.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT,zt=a.get(z),Rt=T.length>1;if(Rt)for(let Kt=0;Kt<T.length;Kt++)n.bindFramebuffer(r.FRAMEBUFFER,zt.__webglMultisampledFramebuffer),r.framebufferRenderbuffer(r.FRAMEBUFFER,r.COLOR_ATTACHMENT0+Kt,r.RENDERBUFFER,null),n.bindFramebuffer(r.FRAMEBUFFER,zt.__webglFramebuffer),r.framebufferTexture2D(r.DRAW_FRAMEBUFFER,r.COLOR_ATTACHMENT0+Kt,r.TEXTURE_2D,null,0);n.bindFramebuffer(r.READ_FRAMEBUFFER,zt.__webglMultisampledFramebuffer);const Yt=z.texture.mipmaps;Yt&&Yt.length>0?n.bindFramebuffer(r.DRAW_FRAMEBUFFER,zt.__webglFramebuffer[0]):n.bindFramebuffer(r.DRAW_FRAMEBUFFER,zt.__webglFramebuffer);for(let Kt=0;Kt<T.length;Kt++){if(z.resolveDepthBuffer&&(z.depthBuffer&&(_t|=r.DEPTH_BUFFER_BIT),z.stencilBuffer&&z.resolveStencilBuffer&&(_t|=r.STENCIL_BUFFER_BIT)),Rt){r.framebufferRenderbuffer(r.READ_FRAMEBUFFER,r.COLOR_ATTACHMENT0,r.RENDERBUFFER,zt.__webglColorRenderbuffer[Kt]);const St=a.get(T[Kt]).__webglTexture;r.framebufferTexture2D(r.DRAW_FRAMEBUFFER,r.COLOR_ATTACHMENT0,r.TEXTURE_2D,St,0)}r.blitFramebuffer(0,0,it,pt,0,0,it,pt,_t,r.NEAREST),d===!0&&(ue.length=0,se.length=0,ue.push(r.COLOR_ATTACHMENT0+Kt),z.depthBuffer&&z.resolveDepthBuffer===!1&&(ue.push(ht),se.push(ht),r.invalidateFramebuffer(r.DRAW_FRAMEBUFFER,se)),r.invalidateFramebuffer(r.READ_FRAMEBUFFER,ue))}if(n.bindFramebuffer(r.READ_FRAMEBUFFER,null),n.bindFramebuffer(r.DRAW_FRAMEBUFFER,null),Rt)for(let Kt=0;Kt<T.length;Kt++){n.bindFramebuffer(r.FRAMEBUFFER,zt.__webglMultisampledFramebuffer),r.framebufferRenderbuffer(r.FRAMEBUFFER,r.COLOR_ATTACHMENT0+Kt,r.RENDERBUFFER,zt.__webglColorRenderbuffer[Kt]);const St=a.get(T[Kt]).__webglTexture;n.bindFramebuffer(r.FRAMEBUFFER,zt.__webglFramebuffer),r.framebufferTexture2D(r.DRAW_FRAMEBUFFER,r.COLOR_ATTACHMENT0+Kt,r.TEXTURE_2D,St,0)}n.bindFramebuffer(r.DRAW_FRAMEBUFFER,zt.__webglMultisampledFramebuffer)}else if(z.depthBuffer&&z.resolveDepthBuffer===!1&&d){const T=z.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT;r.invalidateFramebuffer(r.DRAW_FRAMEBUFFER,[T])}}}function qe(z){return Math.min(o.maxSamples,z.samples)}function kt(z){const T=a.get(z);return z.samples>0&&t.has("WEBGL_multisampled_render_to_texture")===!0&&T.__useRenderToTexture!==!1}function fe(z){const T=u.render.frame;g.get(z)!==T&&(g.set(z,T),z.update())}function Qe(z,T){const it=z.colorSpace,pt=z.format,_t=z.type;return z.isCompressedTexture===!0||z.isVideoTexture===!0||it!==Wr&&it!==pa&&(Ce.getTransfer(it)===ze?(pt!==Ui||_t!==qi)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",it)),T}function Je(z){return typeof HTMLImageElement<"u"&&z instanceof HTMLImageElement?(p.width=z.naturalWidth||z.width,p.height=z.naturalHeight||z.height):typeof VideoFrame<"u"&&z instanceof VideoFrame?(p.width=z.displayWidth,p.height=z.displayHeight):(p.width=z.width,p.height=z.height),p}this.allocateTextureUnit=nt,this.resetTextureUnits=W,this.setTexture2D=ft,this.setTexture2DArray=B,this.setTexture3D=tt,this.setTextureCube=Y,this.rebindTextures=un,this.setupRenderTarget=H,this.updateRenderTargetMipmap=Be,this.updateMultisampleRenderTarget=Ot,this.setupDepthRenderbuffer=_e,this.setupFrameBufferTexture=wt,this.useMultisampledRTT=kt}function p2(r,t){function n(a,o=pa){let c;const u=Ce.getTransfer(o);if(a===qi)return r.UNSIGNED_BYTE;if(a===gp)return r.UNSIGNED_SHORT_4_4_4_4;if(a===vp)return r.UNSIGNED_SHORT_5_5_5_1;if(a===q_)return r.UNSIGNED_INT_5_9_9_9_REV;if(a===Y_)return r.UNSIGNED_INT_10F_11F_11F_REV;if(a===X_)return r.BYTE;if(a===W_)return r.SHORT;if(a===ml)return r.UNSIGNED_SHORT;if(a===mp)return r.INT;if(a===zs)return r.UNSIGNED_INT;if(a===ki)return r.FLOAT;if(a===va)return r.HALF_FLOAT;if(a===j_)return r.ALPHA;if(a===Z_)return r.RGB;if(a===Ui)return r.RGBA;if(a===vl)return r.DEPTH_COMPONENT;if(a===_l)return r.DEPTH_STENCIL;if(a===_p)return r.RED;if(a===xp)return r.RED_INTEGER;if(a===K_)return r.RG;if(a===yp)return r.RG_INTEGER;if(a===Mp)return r.RGBA_INTEGER;if(a===cu||a===uu||a===fu||a===hu)if(u===ze)if(c=t.get("WEBGL_compressed_texture_s3tc_srgb"),c!==null){if(a===cu)return c.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(a===uu)return c.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(a===fu)return c.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(a===hu)return c.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(c=t.get("WEBGL_compressed_texture_s3tc"),c!==null){if(a===cu)return c.COMPRESSED_RGB_S3TC_DXT1_EXT;if(a===uu)return c.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(a===fu)return c.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(a===hu)return c.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(a===Ud||a===Ld||a===Nd||a===Pd)if(c=t.get("WEBGL_compressed_texture_pvrtc"),c!==null){if(a===Ud)return c.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(a===Ld)return c.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(a===Nd)return c.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(a===Pd)return c.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(a===Od||a===zd||a===Bd)if(c=t.get("WEBGL_compressed_texture_etc"),c!==null){if(a===Od||a===zd)return u===ze?c.COMPRESSED_SRGB8_ETC2:c.COMPRESSED_RGB8_ETC2;if(a===Bd)return u===ze?c.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:c.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(a===Id||a===Fd||a===Hd||a===Gd||a===Vd||a===kd||a===Xd||a===Wd||a===qd||a===Yd||a===jd||a===Zd||a===Kd||a===Qd)if(c=t.get("WEBGL_compressed_texture_astc"),c!==null){if(a===Id)return u===ze?c.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:c.COMPRESSED_RGBA_ASTC_4x4_KHR;if(a===Fd)return u===ze?c.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:c.COMPRESSED_RGBA_ASTC_5x4_KHR;if(a===Hd)return u===ze?c.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:c.COMPRESSED_RGBA_ASTC_5x5_KHR;if(a===Gd)return u===ze?c.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:c.COMPRESSED_RGBA_ASTC_6x5_KHR;if(a===Vd)return u===ze?c.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:c.COMPRESSED_RGBA_ASTC_6x6_KHR;if(a===kd)return u===ze?c.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:c.COMPRESSED_RGBA_ASTC_8x5_KHR;if(a===Xd)return u===ze?c.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:c.COMPRESSED_RGBA_ASTC_8x6_KHR;if(a===Wd)return u===ze?c.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:c.COMPRESSED_RGBA_ASTC_8x8_KHR;if(a===qd)return u===ze?c.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:c.COMPRESSED_RGBA_ASTC_10x5_KHR;if(a===Yd)return u===ze?c.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:c.COMPRESSED_RGBA_ASTC_10x6_KHR;if(a===jd)return u===ze?c.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:c.COMPRESSED_RGBA_ASTC_10x8_KHR;if(a===Zd)return u===ze?c.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:c.COMPRESSED_RGBA_ASTC_10x10_KHR;if(a===Kd)return u===ze?c.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:c.COMPRESSED_RGBA_ASTC_12x10_KHR;if(a===Qd)return u===ze?c.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:c.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(a===Jd||a===$d||a===tp)if(c=t.get("EXT_texture_compression_bptc"),c!==null){if(a===Jd)return u===ze?c.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:c.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(a===$d)return c.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(a===tp)return c.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(a===ep||a===np||a===ip||a===ap)if(c=t.get("EXT_texture_compression_rgtc"),c!==null){if(a===ep)return c.COMPRESSED_RED_RGTC1_EXT;if(a===np)return c.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(a===ip)return c.COMPRESSED_RED_GREEN_RGTC2_EXT;if(a===ap)return c.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return a===gl?r.UNSIGNED_INT_24_8:r[a]!==void 0?r[a]:null}return{convert:n}}const m2=`
void main() {
...
}`;class v2{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(t,n){if(this.texture===null){const a=new ux(t.texture);(t.depthNear!==n.depthNear||t.depthFar!==n.depthFar)&&(this.depthNear=t.depthNear,this.depthFar=t.depthFar),this.texture=a}}getMesh(t){if(this.texture!==null&&this.mesh===null){const n=t.cameras[0].viewport,a=new mn({vertexShader:m2,fragmentShader:g2,uniforms:{depthColor:{value:this.texture},depthWidth:{value:n.z},depthHeight:{value:n.w}}});this.mesh=new qt(new es(20,20),a)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class _2 extends Kr{constructor(t,n){super();const a=this;let o=null,c=1,u=null,h="local-floor",d=1,p=null,g=null,v=null,_=null,x=null,S=null;const E=typeof XRWebGLBinding<"u",M=new v2,y={},L=n.getContextAttributes();let U=null,w=null;const P=[],O=[],F=new It;let G=null;const R=new $n;R.viewport=new Ve;const D=new $n;D.viewport=new Ve;const V=[R,D],W=new F1;let nt=null,ot=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(at){let yt=P[at];return yt===void 0&&(yt=new id,P[at]=yt),yt.getTargetRaySpace()},this.getControllerGrip=function(at){let yt=P[at];return yt===void 0&&(yt=new id,P[at]=yt),yt.getGripSpace()},this.getHand=function(at){let yt=P[at];return yt===void 0&&(yt=new id,P[at]=yt),yt.getHandSpace()};function ft(at){const yt=O.indexOf(at.inputSource);if(yt===-1)return;const wt=P[yt];wt!==void 0&&(wt.update(at.inputSource,at.frame,p||u),wt.dispatchEvent({type:at.type,data:at.inputSource}))}function B(){o.removeEventListener("select",ft),o.removeEventListener("selectstart",ft),o.removeEventListener("selectend",ft),o.removeEventListener("squeeze",ft),o.removeEventListener("squeezestart",ft),o.removeEventListener("squeezeend",ft),o.removeEventListener("end",B),o.removeEventListener("inputsourceschange",tt);for(let at=0;at<P.length;at++){const yt=O[at];yt!==null&&(O[at]=null,P[at].disconnect(yt))}nt=null,ot=null,M.reset();for(const at in y)delete y[at];t.setRenderTarget(U),x=null,_=null,v=null,o=null,w=null,Gt.stop(),a.isPresenting=!1,t.setPixelRatio(G),t.setSize(F.width,F.height,!1),a.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(at){c=at,a.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(at){h=at,a.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return p||u},this.setReferenceSpace=function(at){p=at},this.getBaseLayer=function(){return _!==null?_:x},this.getBinding=function(){return v===null&&E&&(v=new XRWebGLBinding(o,n)),v},this.getFrame=function(){return S},this.getSession=function(){return o},this.setSession=async function(at){if(o=at,o!==null){if(U=t.getRenderTarget(),o.addEventListener("select",ft),o.addEventListener("selectstart",ft),o.addEventListener("selectend",ft),o.addEventListener("squeeze",ft),o.addEventListener("squeezestart",ft),o.addEventListener("squeezeend",ft),o.addEventListener("end",B),o.addEventListener("inputsourceschange",tt),L.xrCompatible!==!0&&await n.makeXRCompatible(),G=t.getPixelRatio(),t.getSize(F),E&&"createProjectionLayer"in XRWebGLBinding.prototype){let wt=null,$t=null,Zt=null;L.depth&&(Zt=L.stencil?n.DEPTH24_STENCIL8:n.DEPTH_COMPONENT24,wt=L.stencil?_l:vl,$t=L.stencil?gl:zs);const _e={colorFormat:n.RGBA8,depthFormat:Zt,scaleFactor:c};v=this.getBinding(),_=v.createProjectionLayer(_e),o.updateRenderState({layers:[_]}),t.setPixelRatio(1),t.setSize(_.textureWidth,_.textureHeight,!1),w=new Li(_.textureWidth,_.textureHeight,{format:Ui,type:qi,depthTexture:new cx(_.textureWidth,_.textureHeight,$t,void 0,void 0,void 0,void 0,void 0,void 0,wt),stencilBuffer:L.stencil,colorSpace:t.outputColorSpace,samples:L.antialias?4:0,resolveDepthBuffer:_.ignoreDepthValues===!1,resolveStencilBuffer:_.ignoreDepthValues===!1})}else{const wt={antialias:L.antialias,alpha:!0,depth:L.depth,stencil:L.stencil,framebufferScaleFactor:c};x=new XRWebGLLayer(o,n,wt),o.updateRenderState({baseLayer:x}),t.setPixelRatio(1),t.setSize(x.framebufferWidth,x.framebufferHeight,!1),w=new Li(x.framebufferWidth,x.framebufferHeight,{format:Ui,type:qi,colorSpace:t.outputColorSpace,stencilBuffer:L.stencil,resolveDepthBuffer:x.ignoreDepthValues===!1,resolveStencilBuffer:x.ignoreDepthValues===!1})}w.isXRRenderTarget=!0,this.setFoveation(d),p=null,u=await o.requestReferenceSpace(h),Gt.setContext(o),Gt.start(),a.isPresenting=!0,a.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(o!==null)return o.environmentBlendMode},this.getDepthTexture=function(){return M.getDepthTexture()};function tt(at){for(let yt=0;yt<at.removed.length;yt++){const wt=at.removed[yt],$t=O.indexOf(wt);$t>=0&&(O[$t]=null,P[$t].disconnect(wt))}for(let yt=0;yt<at.added.length;yt++){const wt=at.added[yt];let $t=O.indexOf(wt);if($t===-1){for(let _e=0;_e<P.length;_e++)if(_e>=O.length){O.push(wt),$t=_e;break}else if(O[_e]===null){O[_e]=wt,$t=_e;break}if($t===-1)break}const Zt=P[$t];Zt&&Zt.connect(wt)}}const Y=new k,lt=new k;function N(at,yt,wt){Y.setFromMatrixPosition(yt.matrixWorld),lt.setFromMatrixPosition(wt.matrixWorld);const $t=Y.distanceTo(lt),Zt=yt.projectionMatrix.elements,_e=wt.projectionMatrix.elements,un=Zt[14]/(Zt[10]-1),H=Zt[14]/(Zt[10]+1),Be=(Zt[9]+1)/Zt[5],ue=(Zt[9]-1)/Zt[5],se=(Zt[8]-1)/Zt[0],Ot=(_e[8]+1)/_e[0],qe=un*se,kt=un*Ot,fe=$t/(-se+Ot),Qe=fe*-se;if(yt.matrixWorld.decompose(at.position,at.quaternion,at.scale),at.translateX(Qe),at.translateZ(fe),at.matrixWorld.compose(at.position,at.quaternion,at.scale),at.matrixWorldInverse.copy(at.matrixWorld).invert(),Zt[10]===-1)at.projectionMatrix.copy(yt.projectionMatrix),at.projectionMatrixInverse.copy(yt.projectionMatrixInverse);else{const Je=un+fe,z=H+fe,T=qe-Qe,it=kt+($t-Qe),pt=Be*H/z*Je,_t=ue*H/z*Je;at.projectionMatrix.makePerspective(T,it,pt,_t,Je,z),at.projectionMatrixInverse.copy(at.projectionMatrix).invert()}}function Z(at,yt){yt===null?at.matrixWorld.copy(at.matrix):at.matrixWorld.multiplyMatrices(yt.matrixWorld,at.matrix),at.matrixWorldInverse.copy(at.matrixWorld).invert()}this.updateCamera=function(at){if(o===null)return;let yt=at.near,wt=at.far;M.texture!==null&&(M.depthNear>0&&(yt=M.depthNear),M.depthFar>0&&(wt=M.depthFar)),W.near=D.near=R.near=yt,W.far=D.far=R.far=wt,(nt!==W.near||ot!==W.far)&&(o.updateRenderState({depthNear:W.near,depthFar:W.far}),nt=W.near,ot=W.far),W.layers.mask=at.layers.mask|6,R.layers.mask=W.layers.mask&3,D.layers.mask=W.layers.mask&5;const $t=at.parent,Zt=W.cameras;Z(W,$t);for(let _e=0;_e<Zt.length;_e++)Z(Zt[_e],$t);Zt.length===2?N(W,R,D):W.projectionMatrix.copy(R.projectionMatrix),dt(at,W,$t)};function dt(at,yt,wt){wt===null?at.matrix.copy(yt.matrixWorld):(at.matrix.copy(wt.matrixWorld),at.matrix.invert(),at.matrix.multiply(yt.matrixWorld)),at.matrix.decompose(at.position,at.quaternion,at.scale),at.updateMatrixWorld(!0),at.projectionMatrix.copy(yt.projectionMatrix),at.projectionMatrixInverse.copy(yt.projectionMatrixInverse),at.isPerspectiveCamera&&(at.fov=qr*2*Math.atan(1/at.projectionMatrix.elements[5]),at.zoom=1)}this.getCamera=function(){return W},this.getFoveation=function(){if(!(_===null&&x===null))return d},this.setFoveation=function(at){d=at,_!==null&&(_.fixedFoveation=at),x!==null&&x.fixedFoveation!==void 0&&(x.fixedFoveation=at)},this.hasDepthSensing=function(){return M.texture!==null},this.getDepthSensingMesh=function(){return M.getMesh(W)},this.getCameraTexture=function(at){return y[at]};let vt=null;function At(at,yt){if(g=yt.getViewerPose(p||u),S=yt,g!==null){const wt=g.views;x!==null&&(t.setRenderTargetFramebuffer(w,x.framebuffer),t.setRenderTarget(w));let $t=!1;wt.length!==W.cameras.length&&(W.cameras.length=0,$t=!0);for(let H=0;H<wt.length;H++){const Be=wt[H];let ue=null;if(x!==null)ue=x.getViewport(Be);else{const Ot=v.getViewSubImage(_,Be);ue=Ot.viewport,H===0&&(t.setRenderTargetTextures(w,Ot.colorTexture,Ot.depthStencilTexture),t.setRenderTarget(w))}let se=V[H];se===void 0&&(se=new $n,se.layers.enable(H),se.viewport=new Ve,V[H]=se),se.matrix.fromArray(Be.transform.matrix),se.matrix.decompose(se.position,se.quaternion,se.scale),se.projectionMatrix.fromArray(Be.projectionMatrix),se.projectionMatrixInverse.copy(se.projectionMatrix).invert(),se.viewport.set(ue.x,ue.y,ue.width,ue.height),H===0&&(W.matrix.copy(se.matrix),W.matrix.decompose(W.position,W.quaternion,W.scale)),$t===!0&&W.cameras.push(se)}const Zt=o.enabledFeatures;if(Zt&&Zt.includes("depth-sensing")&&o.depthUsage=="gpu-optimized"&&E){v=a.getBinding();const H=v.getDepthInformation(wt[0]);H&&H.isValid&&H.texture&&M.init(H,o.renderState)}if(Zt&&Zt.includes("camera-access")&&E){t.state.unbindTexture(),v=a.getBinding();for(let H=0;H<wt.length;H++){const Be=wt[H].camera;if(Be){let ue=y[Be];ue||(ue=new ux,y[Be]=ue);const se=v.getCameraImage(Be);ue.sourceTexture=se}}}}for(let wt=0;wt<P.length;wt++){const $t=O[wt],Zt=P[wt];$t!==null&&Zt!==void 0&&Zt.update($t,yt,p||u)}vt&&vt(at,yt),yt.detectedPlanes&&a.dispatchEvent({type:"planesdetected",data:yt}),S=null}const Gt=new mx;Gt.setAnimationLoop(At),this.setAnimationLoop=function(at){vt=at},this.dispose=function(){}}}const As=new Ni,x2=new We;function y2(r,t){function n(M,y){M.matrixAutoUpdate===!0&&M.updateMatrix(),y.value.copy(M.matrix)}function a(M,y){y.color.getRGB(M.fogColor.value,rx(r)),y.isFog?(M.fogNear.value=y.near,M.fogFar.value=y.far):y.isFogExp2&&(M.fogDensity.value=y.density)}function o(M,y,L,U,w){y.isMeshBasicMaterial||y.isMeshLambertMaterial?c(M,y):y.isMeshToonMaterial?(c(M,y),v(M,y)):y.isMeshPhongMaterial?(c(M,y),g(M,y)):y.isMeshStandardMaterial?(c(M,y),_(M,y),y.isMeshPhysicalMaterial&&x(M,y,w)):y.isMeshMatcapMaterial?(c(M,y),S(M,y)):y.isMeshDepthMaterial?c(M,y):y.isMeshDistanceMaterial?(c(M,y),E(M,y)):y.isMeshNormalMaterial?c(M,y):y.isLineBasicMaterial?(u(M,y),y.isLineDashedMaterial&&h(M,y)):y.isPointsMaterial?d(M,y,L,U):y.isSpriteMaterial?p(M,y):y.isShadowMaterial?(M.color.value.copy(y.color),M.opacity.value=y.opacity):y.isShaderMaterial&&(y.uniformsNeedUpdate=!1)}function c(M,y){M.opacity.value=y.opacity,y.color&&M.diffuse.value.copy(y.color),y.emissive&&M.emissive.value.copy(y.emissive).multiplyScalar(y.emissiveIntensity),y.map&&(M.map.value=y.map,n(y.map,M.mapTransform)),y.alphaMap&&(M.alphaMap.value=y.alphaMap,n(y.alphaMap,M.alphaMapTransform)),y.bumpMap&&(M.bumpMap.value=y.bumpMap,n(y.bumpMap,M.bumpMapTransform),M.bumpScale.value=y.bumpScale,y.side===ti&&(M.bumpScale.value*=-1)),y.normalMap&&(M.normalMap.value=y.normalMap,n(y.normalMap,M.normalMapTransform),M.normalScale.value.copy(y.normalScale),y.side===ti&&M.normalScale.value.negate()),y.displacementMap&&(M.displacementMap.value=y.displacementMap,n(y.displacementMap,M.displacementMapTransform),M.displacementScale.value=y.displacementScale,M.displacementBias.value=y.displacementBias),y.emissiveMap&&(M.emissiveMap.value=y.emissiveMap,n(y.emissiveMap,M.emissiveMapTransform)),y.specularMap&&(M.specularMap.value=y.specularMap,n(y.specularMap,M.specularMapTransform)),y.alphaTest>0&&(M.alphaTest.value=y.alphaTest);const L=t.get(y),U=L.envMap,w=L.envMapRotation;U&&(M.envMap.value=U,As.copy(w),As.x*=-1,As.y*=-1,As.z*=-1,U.isCubeTexture&&U.isRenderTargetTexture===!1&&(As.y*=-1,As.z*=-1),M.envMapRotation.value.setFromMatrix4(x2.makeRotationFromEuler(As)),M.flipEnvMap.value=U.isCubeTexture&&U.isRenderTargetTexture===!1?-1:1,M.reflectivity.value=y.reflectivity,M.ior.value=y.ior,M.refractionRatio.value=y.refractionRatio),y.lightMap&&(M.lightMap.value=y.lightMap,M.lightMapIntensity.value=y.lightMapIntensity,n(y.lightMap,M.lightMapTransform)),y.aoMap&&(M.aoMap.value=y.aoMap,M.aoMapIntensity.value=y.aoMapIntensity,n(y.aoMap,M.aoMapTransform))}function u(M,y){M.diffuse.value.copy(y.color),M.opacity.value=y.opacity,y.map&&(M.map.value=y.map,n(y.map,M.mapTransform))}function h(M,y){M.dashSize.value=y.dashSize,M.totalSize.value=y.dashSize+y.gapSize,M.scale.value=y.scale}function d(M,y,L,U){M.diffuse.value.copy(y.color),M.opacity.value=y.opacity,M.size.value=y.size*L,M.scale.value=U*.5,y.map&&(M.map.value=y.map,n(y.map,M.uvTransform)),y.alphaMap&&(M.alphaMap.value=y.alphaMap,n(y.alphaMap,M.alphaMapTransform)),y.alphaTest>0&&(M.alphaTest.value=y.alphaTest)}function p(M,y){M.diffuse.value.copy(y.color),M.opacity.value=y.opacity,M.rotation.value=y.rotation,y.map&&(M.map.value=y.map,n(y.map,M.mapTransform)),y.alphaMap&&(M.alphaMap.value=y.alphaMap,n(y.alphaMap,M.alphaMapTransform)),y.alphaTest>0&&(M.alphaTest.value=y.alphaTest)}function g(M,y){M.specular.value.copy(y.specular),M.shininess.value=Math.max(y.shininess,1e-4)}function v(M,y){y.gradientMap&&(M.gradientMap.value=y.gradientMap)}function _(M,y){M.metalness.value=y.metalness,y.metalnessMap&&(M.metalnessMap.value=y.metalnessMap,n(y.metalnessMap,M.metalnessMapTransform)),M.roughness.value=y.roughness,y.roughnessMap&&(M.roughnessMap.value=y.roughnessMap,n(y.roughnessMap,M.roughnessMapTransform)),y.envMap&&(M.envMapIntensity.value=y.envMapIntensity)}function x(M,y,L){M.ior.value=y.ior,y.sheen>0&&(M.sheenColor.value.copy(y.sheenColor).multiplyScalar(y.sheen),M.sheenRoughness.value=y.sheenRoughness,y.sheenColorMap&&(M.sheenColorMap.value=y.sheenColorMap,n(y.sheenColorMap,M.sheenColorMapTransform)),y.sheenRoughnessMap&&(M.sheenRoughnessMap.value=y.sheenRoughnessMap,n(y.sheenRoughnessMap,M.sheenRoughnessMapTransform))),y.clearcoat>0&&(M.clearcoat.value=y.clearcoat,M.clearcoatRoughness.value=y.clearcoatRoughness,y.clearcoatMap&&(M.clearcoatMap.value=y.clearcoatMap,n(y.clearcoatMap,M.clearcoatMapTransform)),y.clearcoatRoughnessMap&&(M.clearcoatRoughnessMap.value=y.clearcoatRoughnessMap,n(y.clearcoatRoughnessMap,M.clearcoatRoughnessMapTransform)),y.clearcoatNormalMap&&(M.clearcoatNormalMap.value=y.clearcoatNormalMap,n(y.clearcoatNormalMap,M.clearcoatNormalMapTransform),M.clearcoatNormalScale.value.copy(y.clearcoatNormalScale),y.side===ti&&M.clearcoatNormalScale.value.negate())),y.dispersion>0&&(M.dispersion.value=y.dispersion),y.iridescence>0&&(M.iridescence.value=y.iridescence,M.iridescenceIOR.value=y.iridescenceIOR,M.iridescenceThicknessMinimum.value=y.iridescenceThicknessRange[0],M.iridescenceThicknessMaximum.value=y.iridescenceThicknessRange[1],y.iridescenceMap&&(M.iridescenceMap.value=y.iridescenceMap,n(y.iridescenceMap,M.iridescenceMapTransform)),y.iridescenceThicknessMap&&(M.iridescenceThicknessMap.value=y.iridescenceThicknessMap,n(y.iridescenceThicknessMap,M.iridescenceThicknessMapTransform))),y.transmission>0&&(M.transmission.value=y.transmission,M.transmissionSamplerMap.value=L.texture,M.transmissionSamplerSize.value.set(L.width,L.height),y.transmissionMap&&(M.transmissionMap.value=y.transmissionMap,n(y.transmissionMap,M.transmissionMapTransform)),M.thickness.value=y.thickness,y.thicknessMap&&(M.thicknessMap.value=y.thicknessMap,n(y.thicknessMap,M.thicknessMapTransform)),M.attenuationDistance.value=y.attenuationDistance,M.attenuationColor.value.copy(y.attenuationColor)),y.anisotropy>0&&(M.anisotropyVector.value.set(y.anisotropy*Math.cos(y.anisotropyRotation),y.anisotropy*Math.sin(y.anisotropyRotation)),y.anisotropyMap&&(M.anisotropyMap.value=y.anisotropyMap,n(y.anisotropyMap,M.anisotropyMapTransform))),M.specularIntensity.value=y.specularIntensity,M.specularColor.value.copy(y.specularColor),y.specularColorMap&&(M.specularColorMap.value=y.specularColorMap,n(y.specularColorMap,M.specularColorMapTransform)),y.specularIntensityMap&&(M.specularIntensityMap.value=y.specularIntensityMap,n(y.specularIntensityMap,M.specularIntensityMapTransform))}function S(M,y){y.matcap&&(M.matcap.value=y.matcap)}function E(M,y){const L=t.get(y).light;M.referencePosition.value.setFromMatrixPosition(L.matrixWorld),M.nearDistance.value=L.shadow.camera.near,M.farDistance.value=L.shadow.camera.far}return{refreshFogUniforms:a,refreshMaterialUniforms:o}}function M2(r,t,n,a){let o={},c={},u=[];const h=r.getParameter(r.MAX_UNIFORM_BUFFER_BINDINGS);function d(L,U){const w=U.program;a.uniformBlockBinding(L,w)}function p(L,U){let w=o[L.id];w===void 0&&(S(L),w=g(L),o[L.id]=w,L.addEventListener("dispose",M));const P=U.program;a.updateUBOMapping(L,P);const O=t.render.frame;c[L.id]!==O&&(_(L),c[L.id]=O)}function g(L){const U=v();L.__bindingPointIndex=U;const w=r.createBuffer(),P=L.__size,O=L.usage;return r.bindBuffer(r.UNIFORM_BUFFER,w),r.bufferData(r.UNIFORM_BUFFER,P,O),r.bindBuffer(r.UNIFORM_BUFFER,null),r.bindBufferBase(r.UNIFORM_BUFFER,U,w),w}function v(){for(let L=0;L<h;L++)if(u.indexOf(L)===-1)return u.push(L),L;return console.error("THREE.WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function _(L){const U=o[L.id],w=L.uniforms,P=L.__cache;r.bindBuffer(r.UNIFORM_BUFFER,U);for(let O=0,F=w.length;O<F;O++){const G=Array.isArray(w[O])?w[O]:[w[O]];for(let R=0,D=G.length;R<D;R++){const V=G[R];if(x(V,O,R,P)===!0){const W=V.__offset,nt=Array.isArray(V.value)?V.value:[V.value];let ot=0;for(let ft=0;ft<nt.length;ft++){const B=nt[ft],tt=E(B);typeof B=="number"||typeof B=="boolean"?(V.__data[0]=B,r.bufferSubData(r.UNIFORM_BUFFER,W+ot,V.__data)):B.isMatrix3?(V.__data[0]=B.elements[0],V.__data[1]=B.elements[1],V.__data[2]=B.elements[2],V.__data[3]=0,V.__data[4]=B.elements[3],V.__data[5]=B.elements[4],V.__data[6]=B.elements[5],V.__data[7]=0,V.__data[8]=B.elements[6],V.__data[9]=B.elements[7],V.__data[10]=B.elements[8],V.__data[11]=0):(B.toArray(V.__data,ot),ot+=tt.storage/Float32Array.BYTES_PER_ELEMENT)}r.bufferSubData(r.UNIFORM_BUFFER,W,V.__data)}}}r.bindBuffer(r.UNIFORM_BUFFER,null)}function x(L,U,w,P){const O=L.value,F=U+"_"+w;if(P[F]===void 0)return typeof O=="number"||typeof O=="boolean"?P[F]=O:P[F]=O.clone(),!0;{const G=P[F];if(typeof O=="number"||typeof O=="boolean"){if(G!==O)return P[F]=O,!0}else if(G.equals(O)===!1)return G.copy(O),!0}return!1}function S(L){const U=L.uniforms;let w=0;const P=16;for(let F=0,G=U.length;F<G;F++){const R=Array.isArray(U[F])?U[F]:[U[F]];for(let D=0,V=R.length;D<V;D++){const W=R[D],nt=Array.isArray(W.value)?W.value:[W.value];for(let ot=0,ft=nt.length;ot<ft;ot++){const B=nt[ot],tt=E(B),Y=w%P,lt=Y%tt.boundary,N=Y+lt;w+=lt,N!==0&&P-N<tt.storage&&(w+=P-N),W.__data=new Float32Array(tt.storage/Float32Array.BYTES_PER_ELEMENT),W.__offset=w,w+=tt.storage}}}const O=w%P;return O>0&&(w+=P-O),L.__size=w,L.__cache={},this}function E(L){const U={boundary:0,storage:0};return typeof L=="number"||typeof L=="boolean"?(U.boundary=4,U.storage=4):L.isVector2?(U.boundary=8,U.storage=8):L.isVector3||L.isColor?(U.boundary=16,U.storage=12):L.isVector4?(U.boundary=16,U.storage=16):L.isMatrix3?(U.boundary=48,U.storage=48):L.isMatrix4?(U.boundary=64,U.storage=64):L.isTexture?console.warn("THREE.WebGLRenderer: Texture samplers can not be part of an uniforms group."):console.warn("THREE.WebGLRenderer: Unsupported uniform value type.",L),U}function M(L){const U=L.target;U.removeEventListener("dispose",M);const w=u.indexOf(U.__bindingPointIndex);u.splice(w,1),r.deleteBuffer(o[U.id]),delete o[U.id],delete c[U.id]}function y(){for(const L in o)r.deleteBuffer(o[L]);u=[],o={},c={}}return{bind:d,update:p,dispose:y}}class S2{constructor(t={}){const{canvas:n=PS(),context:a=null,depth:o=!0,stencil:c=!1,alpha:u=!1,antialias:h=!1,premultipliedAlpha:d=!0,preserveDrawingBuffer:p=!1,powerPreference:g="default",failIfMajorPerformanceCaveat:v=!1,reversedDepthBuffer:_=!1}=t;this.isWebGLRenderer=!0;let x;if(a!==null){if(typeof WebGLRenderingContext<"u"&&a instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");x=a.getContextAttributes().alpha}else x=u;const S=new Uint32Array(4),E=new Int32Array(4);let M=null,y=null;const L=[],U=[];this.domElement=n,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=$a,this.toneMappingExposure=1,this.transmissionResolutionScale=1;const w=this;let P=!1;this._outputColorSpace=Jn;let O=0,F=0,G=null,R=-1,D=null;const V=new Ve,W=new Ve;let nt=null;const ot=new le(0);let ft=0,B=n.width,tt=n.height,Y=1,lt=null,N=null;const Z=new Ve(0,0,B,tt),dt=new Ve(0,0,B,tt);let vt=!1;const At=new Ep;let Gt=!1,at=!1;const yt=new We,wt=new k,$t=new Ve,Zt={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let _e=!1;function un(){return G===null?Y:1}let H=a;function Be(C,j){return n.getContext(C,j)}try{const C={alpha:!0,depth:o,stencil:c,antialias:h,premultipliedAlpha:d,preserveDrawingBuffer:p,powerPreference:g,failIfMajorPerformanceCaveat:v};if("setAttribute"in n&&n.setAttribute("data-engine",`three.js r${dp}`),n.addEventListener("webglcontextlost",Ct,!1),n.addEventListener("webglcontextrestored",Bt,!1),n.addEventListener("webglcontextcreationerror",bt,!1),H===null){const j="webgl2";if(H=Be(j,C),H===null)throw Be(j)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(C){throw console.error("THREE.WebGLRenderer: "+C.message),C}let ue,se,Ot,qe,kt,fe,Qe,Je,z,T,it,pt,_t,ht,zt,Rt,Yt,Kt,St,Lt,Jt,Xt,Dt,he;function q(){ue=new LT(H),ue.init(),Xt=new p2(H,ue),se=new TT(H,ue,t,Xt),Ot=new h2(H,ue),se.reversedDepthBuffer&&_&&Ot.buffers.depth.setReversed(!0),qe=new OT(H),kt=new $A,fe=new d2(H,ue,Ot,kt,se,Xt,qe),Qe=new wT(w),Je=new UT(w),z=new G1(H),Dt=new bT(H,z),T=new NT(H,z,qe,Dt),it=new BT(H,T,z,qe),St=new zT(H,se,fe),Rt=new AT(kt),pt=new JA(w,Qe,Je,ue,se,Dt,Rt),_t=new y2(w,kt),ht=new e2,zt=new o2(ue),Kt=new ST(w,Qe,Je,Ot,it,x,d),Yt=new u2(w,it,se),he=new M2(H,qe,se,Ot),Lt=new ET(H,ue,qe),Jt=new PT(H,ue,qe),qe.programs=pt.programs,w.capabilities=se,w.extensions=ue,w.properties=kt,w.renderLists=ht,w.shadowMap=Yt,w.state=Ot,w.info=qe}q();const Tt=new _2(w,H);this.xr=Tt,this.getContext=function(){return H},this.getContextAttributes=function(){return H.getContextAttributes()},this.forceContextLoss=function(){const C=ue.get("WEBGL_lose_context");C&&C.loseContext()},this.forceContextRestore=function(){const C=ue.get("WEBGL_lose_context");C&&C.restoreContext()},this.getPixelRatio=function(){return Y},this.setPixelRatio=function(C){C!==void 0&&(Y=C,this.setSize(B,tt,!1))},this.getSize=function(C){return C.set(B,tt)},this.setSize=function(C,j,ct=!0){if(Tt.isPresenting){console.warn("THREE.WebGLRenderer: Can't change size while VR device is presenting.");return}B=C,tt=j,n.width=Math.floor(C*Y),n.height=Math.floor(j*Y),ct===!0&&(n.style.width=C+"px",n.style.height=j+"px"),this.setViewport(0,0,C,j)},this.getDrawingBufferSize=function(C){return C.set(B*Y,tt*Y).floor()},this.setDrawingBufferSize=function(C,j,ct){B=C,tt=j,Y=ct,n.width=Math.floor(C*ct),n.height=Math.floor(j*ct),this.setViewport(0,0,C,j)},this.getCurrentViewport=function(C){return C.copy(V)},this.getViewport=function(C){return C.copy(Z)},this.setViewport=function(C,j,ct,ut){C.isVector4?Z.set(C.x,C.y,C.z,C.w):Z.set(C,j,ct,ut),Ot.viewport(V.copy(Z).multiplyScalar(Y).round())},this.getScissor=function(C){return C.copy(dt)},this.setScissor=function(C,j,ct,ut){C.isVector4?dt.set(C.x,C.y,C.z,C.w):dt.set(C,j,ct,ut),Ot.scissor(W.copy(dt).multiplyScalar(Y).round())},this.getScissorTest=function(){return vt},this.setScissorTest=function(C){Ot.setScissorTest(vt=C)},this.setOpaqueSort=function(C){lt=C},this.setTransparentSort=function(C){N=C},this.getClearColor=function(C){return C.copy(Kt.getClearColor())},this.setClearColor=function(){Kt.setClearColor(...arguments)},this.getClearAlpha=function(){return Kt.getClearAlpha()},this.setClearAlpha=function(){Kt.setClearAlpha(...arguments)},this.clear=function(C=!0,j=!0,ct=!0){let ut=0;if(C){let J=!1;if(G!==null){const Et=G.texture.format;J=Et===Mp||Et===yp||Et===xp}if(J){const Et=G.texture.type,Ut=Et===qi||Et===zs||Et===ml||Et===gl||Et===gp||Et===vp,Ft=Kt.getClearColor(),Nt=Kt.getClearAlpha(),ee=Ft.r,ie=Ft.g,jt=Ft.b;Ut?(S[0]=ee,S[1]=ie,S[2]=jt,S[3]=Nt,H.clearBufferuiv(H.COLOR,0,S)):(E[0]=ee,E[1]=ie,E[2]=jt,E[3]=Nt,H.clearBufferiv(H.COLOR,0,E))}else ut|=H.COLOR_BUFFER_BIT}j&&(ut|=H.DEPTH_BUFFER_BIT),ct&&(ut|=H.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),H.clear(ut)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){n.removeEventListener("webglcontextlost",Ct,!1),n.removeEventListener("webglcontextrestored",Bt,!1),n.removeEventListener("webglcontextcreationerror",bt,!1),Kt.dispose(),ht.dispose(),zt.dispose(),kt.dispose(),Qe.dispose(),Je.dispose(),it.dispose(),Dt.dispose(),he.dispose(),pt.dispose(),Tt.dispose(),Tt.removeEventListener("sessionstart",gn),Tt.removeEventListener("sessionend",vn),tn.stop()};function Ct(C){C.preventDefault(),console.log("THREE.WebGLRenderer: Context Lost."),P=!0}function Bt(){console.log("THREE.WebGLRenderer: Context Restored."),P=!1;const C=qe.autoReset,j=Yt.enabled,ct=Yt.autoUpdate,ut=Yt.needsUpdate,J=Yt.type;q(),qe.autoReset=C,Yt.enabled=j,Yt.autoUpdate=ct,Yt.needsUpdate=ut,Yt.type=J}function bt(C){console.error("THREE.WebGLRenderer: A WebGL context could not be created. Reason: ",C.statusMessage)}function Mt(C){const j=C.target;j.removeEventListener("dispose",Mt),Vt(j)}function Vt(C){oe(C),kt.remove(C)}function oe(C){const j=kt.get(C).programs;j!==void 0&&(j.forEach(function(ct){pt.releaseProgram(ct)}),C.isShaderMaterial&&pt.releaseShaderCache(C))}this.renderBufferDirect=function(C,j,ct,ut,J,Et){j===null&&(j=Zt);const Ut=J.isMesh&&J.matrixWorld.determinant()<0,Ft=ya(C,j,ct,ut,J);Ot.setMaterial(ut,Ut);let Nt=ct.index,ee=1;if(ut.wireframe===!0){if(Nt=T.getWireframeAttribute(ct),Nt===void 0)return;ee=2}const ie=ct.drawRange,jt=ct.attributes.position;let me=ie.start*ee,De=(ie.start+ie.count)*ee;Et!==null&&(me=Math.max(me,Et.start*ee),De=Math.min(De,(Et.start+Et.count)*ee)),Nt!==null?(me=Math.max(me,0),De=Math.min(De,Nt.count)):jt!=null&&(me=Math.max(me,0),De=Math.min(De,jt.count));const Ze=De-me;if(Ze<0||Ze===1/0)return;Dt.setup(J,ut,Ft,ct,Nt);let Ie,ge=Lt;if(Nt!==null&&(Ie=z.get(Nt),ge=Jt,ge.setIndex(Ie)),J.isMesh)ut.wireframe===!0?(Ot.setLineWidth(ut.wireframeLinewidth*un()),ge.setMode(H.LINES)):ge.setMode(H.TRIANGLES);else if(J.isLine){let te=ut.linewidth;te===void 0&&(te=1),Ot.setLineWidth(te*un()),J.isLineSegments?ge.setMode(H.LINES):J.isLineLoop?ge.setMode(H.LINE_LOOP):ge.setMode(H.LINE_STRIP)}else J.isPoints?ge.setMode(H.POINTS):J.isSprite&&ge.setMode(H.TRIANGLES);if(J.isBatchedMesh)if(J._multiDrawInstances!==null)yl("THREE.WebGLRenderer: renderMultiDrawInstances has been deprecated and will be removed in r184. Append to renderMultiDraw arguments and use indirection."),ge.renderMultiDrawInstances(J._multiDrawStarts,J._multiDrawCounts,J._multiDrawCount,J._multiDrawInstances);else if(ue.get("WEBGL_multi_draw"))ge.renderMultiDraw(J._multiDrawStarts,J._multiDrawCounts,J._multiDrawCount);else{const te=J._multiDrawStarts,je=J._multiDrawCounts,be=J._multiDrawCount,Pn=Nt?z.get(Nt).bytesPerElement:1,Si=kt.get(ut).currentProgram.getUniforms();for(let Gn=0;Gn<be;Gn++)Si.setValue(H,"_gl_DrawID",Gn),ge.render(te[Gn]/Pn,je[Gn])}else if(J.isInstancedMesh)ge.renderInstances(me,Ze,J.count);else if(ct.isInstancedBufferGeometry){const te=ct._maxInstanceCount!==void 0?ct._maxInstanceCount:1/0,je=Math.min(ct.instanceCount,te);ge.renderInstances(me,Ze,je)}else ge.render(me,Ze)};function Ne(C,j,ct){C.transparent===!0&&C.side===Nn&&C.forceSinglePass===!1?(C.side=ti,C.needsUpdate=!0,Oi(C,j,ct),C.side=ts,C.needsUpdate=!0,Oi(C,j,ct),C.side=Nn):Oi(C,j,ct)}this.compile=function(C,j,ct=null){ct===null&&(ct=C),y=zt.get(ct),y.init(j),U.push(y),ct.traverseVisible(function(J){J.isLight&&J.layers.test(j.layers)&&(y.pushLight(J),J.castShadow&&y.pushShadow(J))}),C!==ct&&C.traverseVisible(function(J){J.isLight&&J.layers.test(j.layers)&&(y.pushLight(J),J.castShadow&&y.pushShadow(J))}),y.setupLights();const ut=new Set;return C.traverse(function(J){if(!(J.isMesh||J.isPoints||J.isLine||J.isSprite))return;const Et=J.material;if(Et)if(Array.isArray(Et))for(let Ut=0;Ut<Et.length;Ut++){const Ft=Et[Ut];Ne(Ft,ct,J),ut.add(Ft)}else Ne(Et,ct,J),ut.add(Et)}),y=U.pop(),ut},this.compileAsync=function(C,j,ct=null){const ut=this.compile(C,j,ct);return new Promise(J=>{function Et(){if(ut.forEach(function(Ut){kt.get(Ut).currentProgram.isReady()&&ut.delete(Ut)}),ut.size===0){J(C);return}setTimeout(Et,10)}ue.get("KHR_parallel_shader_compile")!==null?Et():setTimeout(Et,10)})};let we=null;function Mi(C){we&&we(C)}function gn(){tn.stop()}function vn(){tn.start()}const tn=new mx;tn.setAnimationLoop(Mi),typeof self<"u"&&tn.setContext(self),this.setAnimationLoop=function(C){we=C,Tt.setAnimationLoop(C),C===null?tn.stop():tn.start()},Tt.addEventListener("sessionstart",gn),Tt.addEventListener("sessionend",vn),this.render=function(C,j){if(j!==void 0&&j.isCamera!==!0){console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(P===!0)return;if(C.matrixWorldAutoUpdate===!0&&C.updateMatrixWorld(),j.parent===null&&j.matrixWorldAutoUpdate===!0&&j.updateMatrixWorld(),Tt.enabled===!0&&Tt.isPresenting===!0&&(Tt.cameraAutoUpdate===!0&&Tt.updateCamera(j),j=Tt.getCamera()),C.isScene===!0&&C.onBeforeRender(w,C,j,G),y=zt.get(C,U.length),y.init(j),U.push(y),yt.multiplyMatrices(j.projectionMatrix,j.matrixWorldInverse),At.setFromProjectionMatrix(yt,Xi,j.reversedDepth),at=this.localClippingEnabled,Gt=Rt.init(this.clippingPlanes,at),M=ht.get(C,L.length),M.init(),L.push(M),Tt.enabled===!0&&Tt.isPresenting===!0){const Et=w.xr.getDepthSensingMesh();Et!==null&&Pi(Et,j,-1/0,w.sortObjects)}Pi(C,j,0,w.sortObjects),M.finish(),w.sortObjects===!0&&M.sort(lt,N),_e=Tt.enabled===!1||Tt.isPresenting===!1||Tt.hasDepthSensing()===!1,_e&&Kt.addToRenderList(M,C),this.info.render.frame++,Gt===!0&&Rt.beginShadows();const ct=y.state.shadowsArray;Yt.render(ct,C,j),Gt===!0&&Rt.endShadows(),this.info.autoReset===!0&&this.info.reset();const ut=M.opaque,J=M.transmissive;if(y.setupLights(),j.isArrayCamera){const Et=j.cameras;if(J.length>0)for(let Ut=0,Ft=Et.length;Ut<Ft;Ut++){const Nt=Et[Ut];bl(ut,J,C,Nt)}_e&&Kt.render(C);for(let Ut=0,Ft=Et.length;Ut<Ft;Ut++){const Nt=Et[Ut];Is(M,C,Nt,Nt.viewport)}}else J.length>0&&bl(ut,J,C,j),_e&&Kt.render(C),Is(M,C,j);G!==null&&F===0&&(fe.updateMultisampleRenderTarget(G),fe.updateRenderTargetMipmap(G)),C.isScene===!0&&C.onAfterRender(w,C,j),Dt.resetDefaultState(),R=-1,D=null,U.pop(),U.length>0?(y=U[U.length-1],Gt===!0&&Rt.setGlobalState(w.clippingPlanes,y.state.camera)):y=null,L.pop(),L.length>0?M=L[L.length-1]:M=null};function Pi(C,j,ct,ut){if(C.visible===!1)return;if(C.layers.test(j.layers)){if(C.isGroup)ct=C.renderOrder;else if(C.isLOD)C.autoUpdate===!0&&C.update(j);else if(C.isLight)y.pushLight(C),C.castShadow&&y.pushShadow(C);else if(C.isSprite){if(!C.frustumCulled||At.intersectsSprite(C)){ut&&$t.setFromMatrixPosition(C.matrixWorld).applyMatrix4(yt);const Ut=it.update(C),Ft=C.material;Ft.visible&&M.push(C,Ut,Ft,ct,$t.z,null)}}else if((C.isMesh||C.isLine||C.isPoints)&&(!C.frustumCulled||At.intersectsObject(C))){const Ut=it.update(C),Ft=C.material;if(ut&&(C.boundingSphere!==void 0?(C.boundingSphere===null&&C.computeBoundingSphere(),$t.copy(C.boundingSphere.center)):(Ut.boundingSphere===null&&Ut.computeBoundingSphere(),$t.copy(Ut.boundingSphere.center)),$t.applyMatrix4(C.matrixWorld).applyMatrix4(yt)),Array.isArray(Ft)){const Nt=Ut.groups;for(let ee=0,ie=Nt.length;ee<ie;ee++){const jt=Nt[ee],me=Ft[jt.materialIndex];me&&me.visible&&M.push(C,Ut,me,ct,$t.z,jt)}}else Ft.visible&&M.push(C,Ut,Ft,ct,$t.z,null)}}const Et=C.children;for(let Ut=0,Ft=Et.length;Ut<Ft;Ut++)Pi(Et[Ut],j,ct,ut)}function Is(C,j,ct,ut){const J=C.opaque,Et=C.transmissive,Ut=C.transparent;y.setupLightsView(ct),Gt===!0&&Rt.setGlobalState(w.clippingPlanes,ct),ut&&Ot.viewport(V.copy(ut)),J.length>0&&Fs(J,j,ct),Et.length>0&&Fs(Et,j,ct),Ut.length>0&&Fs(Ut,j,ct),Ot.buffers.depth.setTest(!0),Ot.buffers.depth.setMask(!0),Ot.buffers.color.setMask(!0),Ot.setPolygonOffset(!1)}function bl(C,j,ct,ut){if((ct.isScene===!0?ct.overrideMaterial:null)!==null)return;y.state.transmissionRenderTarget[ut.id]===void 0&&(y.state.transmissionRenderTarget[ut.id]=new Li(1,1,{generateMipmaps:!0,type:ue.has("EXT_color_buffer_half_float")||ue.has("EXT_color_buffer_float")?va:qi,minFilter:Qa,samples:4,stencilBuffer:c,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:Ce.workingColorSpace}));const Et=y.state.transmissionRenderTarget[ut.id],Ut=ut.viewport||V;Et.setSize(Ut.z*w.transmissionResolutionScale,Ut.w*w.transmissionResolutionScale);const Ft=w.getRenderTarget(),Nt=w.getActiveCubeFace(),ee=w.getActiveMipmapLevel();w.setRenderTarget(Et),w.getClearColor(ot),ft=w.getClearAlpha(),ft<1&&w.setClearColor(16777215,.5),w.clear(),_e&&Kt.render(ct);const ie=w.toneMapping;w.toneMapping=$a;const jt=ut.viewport;if(ut.viewport!==void 0&&(ut.viewport=void 0),y.setupLightsView(ut),Gt===!0&&Rt.setGlobalState(w.clippingPlanes,ut),Fs(C,ct,ut),fe.updateMultisampleRenderTarget(Et),fe.updateRenderTargetMipmap(Et),ue.has("WEBGL_multisampled_render_to_texture")===!1){let me=!1;for(let De=0,Ze=j.length;De<Ze;De++){const Ie=j[De],ge=Ie.object,te=Ie.geometry,je=Ie.material,be=Ie.group;if(je.side===Nn&&ge.layers.test(ut.layers)){const Pn=je.side;je.side=ti,je.needsUpdate=!0,io(ge,ct,ut,te,je,be),je.side=Pn,je.needsUpdate=!0,me=!0}}me===!0&&(fe.updateMultisampleRenderTarget(Et),fe.updateRenderTargetMipmap(Et))}w.setRenderTarget(Ft,Nt,ee),w.setClearColor(ot,ft),jt!==void 0&&(ut.viewport=jt),w.toneMapping=ie}function Fs(C,j,ct){const ut=j.isScene===!0?j.overrideMaterial:null;for(let J=0,Et=C.length;J<Et;J++){const Ut=C[J],Ft=Ut.object,Nt=Ut.geometry,ee=Ut.group;let ie=Ut.material;ie.allowOverride===!0&&ut!==null&&(ie=ut),Ft.layers.test(ct.layers)&&io(Ft,j,ct,Nt,ie,ee)}}function io(C,j,ct,ut,J,Et){C.onBeforeRender(w,j,ct,ut,J,Et),C.modelViewMatrix.multiplyMatrices(ct.matrixWorldInverse,C.matrixWorld),C.normalMatrix.getNormalMatrix(C.modelViewMatrix),J.onBeforeRender(w,j,ct,ut,C,Et),J.transparent===!0&&J.side===Nn&&J.forceSinglePass===!1?(J.side=ti,J.needsUpdate=!0,w.renderBufferDirect(ct,j,ut,J,C,Et),J.side=ts,J.needsUpdate=!0,w.renderBufferDirect(ct,j,ut,J,C,Et),J.side=Nn):w.renderBufferDirect(ct,j,ut,J,C,Et),C.onAfterRender(w,j,ct,ut,J,Et)}function Oi(C,j,ct){j.isScene!==!0&&(j=Zt);const ut=kt.get(C),J=y.state.lights,Et=y.state.shadowsArray,Ut=J.state.version,Ft=pt.getParameters(C,J.state,Et,j,ct),Nt=pt.getProgramCacheKey(Ft);let ee=ut.programs;ut.environment=C.isMeshStandardMaterial?j.environment:null,ut.fog=j.fog,ut.envMap=(C.isMeshStandardMaterial?Je:Qe).get(C.envMap||ut.environment),ut.envMapRotation=ut.environment!==null&&C.envMap===null?j.environmentRotation:C.envMapRotation,ee===void 0&&(C.addEventListener("dispose",Mt),ee=new Map,ut.programs=ee);let ie=ee.get(Nt);if(ie!==void 0){if(ut.currentProgram===ie&&ut.lightsStateVersion===Ut)return Yi(C,Ft),ie}else Ft.uniforms=pt.getUniforms(C),C.onBeforeCompile(Ft,w),ie=pt.acquireProgram(Ft,Nt),ee.set(Nt,ie),ut.uniforms=Ft.uniforms;const jt=ut.uniforms;return(!C.isShaderMaterial&&!C.isRawShaderMaterial||C.clipping===!0)&&(jt.clippingPlanes=Rt.uniform),Yi(C,Ft),ut.needsLights=Ma(C),ut.lightsStateVersion=Ut,ut.needsLights&&(jt.ambientLightColor.value=J.state.ambient,jt.lightProbe.value=J.state.probe,jt.directionalLights.value=J.state.directional,jt.directionalLightShadows.value=J.state.directionalShadow,jt.spotLights.value=J.state.spot,jt.spotLightShadows.value=J.state.spotShadow,jt.rectAreaLights.value=J.state.rectArea,jt.ltc_1.value=J.state.rectAreaLTC1,jt.ltc_2.value=J.state.rectAreaLTC2,jt.pointLights.value=J.state.point,jt.pointLightShadows.value=J.state.pointShadow,jt.hemisphereLights.value=J.state.hemi,jt.directionalShadowMap.value=J.state.directionalShadowMap,jt.directionalShadowMatrix.value=J.state.directionalShadowMatrix,jt.spotShadowMap.value=J.state.spotShadowMap,jt.spotLightMatrix.value=J.state.spotLightMatrix,jt.spotLightMap.value=J.state.spotLightMap,jt.pointShadowMap.value=J.state.pointShadowMap,jt.pointShadowMatrix.value=J.state.pointShadowMatrix),ut.currentProgram=ie,ut.uniformsList=null,ie}function Hs(C){if(C.uniformsList===null){const j=C.currentProgram.getUniforms();C.uniformsList=du.seqWithValue(j.seq,C.uniforms)}return C.uniformsList}function Yi(C,j){const ct=kt.get(C);ct.outputColorSpace=j.outputColorSpace,ct.batching=j.batching,ct.batchingColor=j.batchingColor,ct.instancing=j.instancing,ct.instancingColor=j.instancingColor,ct.instancingMorph=j.instancingMorph,ct.skinning=j.skinning,ct.morphTargets=j.morphTargets,ct.morphNormals=j.morphNormals,ct.morphColors=j.morphColors,ct.morphTargetsCount=j.morphTargetsCount,ct.numClippingPlanes=j.numClippingPlanes,ct.numIntersection=j.numClipIntersection,ct.vertexAlphas=j.vertexAlphas,ct.vertexTangents=j.vertexTangents,ct.toneMapping=j.toneMapping}function ya(C,j,ct,ut,J){j.isScene!==!0&&(j=Zt),fe.resetTextureUnits();const Et=j.fog,Ut=ut.isMeshStandardMaterial?j.environment:null,Ft=G===null?w.outputColorSpace:G.isXRRenderTarget===!0?G.texture.colorSpace:Wr,Nt=(ut.isMeshStandardMaterial?Je:Qe).get(ut.envMap||Ut),ee=ut.vertexColors===!0&&!!ct.attributes.color&&ct.attributes.color.itemSize===4,ie=!!ct.attributes.tangent&&(!!ut.normalMap||ut.anisotropy>0),jt=!!ct.morphAttributes.position,me=!!ct.morphAttributes.normal,De=!!ct.morphAttributes.color;let Ze=$a;ut.toneMapped&&(G===null||G.isXRRenderTarget===!0)&&(Ze=w.toneMapping);const Ie=ct.morphAttributes.position||ct.morphAttributes.normal||ct.morphAttributes.color,ge=Ie!==void 0?Ie.length:0,te=kt.get(ut),je=y.state.lights;if(Gt===!0&&(at===!0||C!==D)){const en=C===D&&ut.id===R;Rt.setState(ut,C,en)}let be=!1;ut.version===te.__version?(te.needsLights&&te.lightsStateVersion!==je.state.version||te.outputColorSpace!==Ft||J.isBatchedMesh&&te.batching===!1||!J.isBatchedMesh&&te.batching===!0||J.isBatchedMesh&&te.batchingColor===!0&&J.colorTexture===null||J.isBatchedMesh&&te.batchingColor===!1&&J.colorTexture!==null||J.isInstancedMesh&&te.instancing===!1||!J.isInstancedMesh&&te.instancing===!0||J.isSkinnedMesh&&te.skinning===!1||!J.isSkinnedMesh&&te.skinning===!0||J.isInstancedMesh&&te.instancingColor===!0&&J.instanceColor===null||J.isInstancedMesh&&te.instancingColor===!1&&J.instanceColor!==null||J.isInstancedMesh&&te.instancingMorph===!0&&J.morphTexture===null||J.isInstancedMesh&&te.instancingMorph===!1&&J.morphTexture!==null||te.envMap!==Nt||ut.fog===!0&&te.fog!==Et||te.numClippingPlanes!==void 0&&(te.numClippingPlanes!==Rt.numPlanes||te.numIntersection!==Rt.numIntersection)||te.vertexAlphas!==ee||te.vertexTangents!==ie||te.morphTargets!==jt||te.morphNormals!==me||te.morphColors!==De||te.toneMapping!==Ze||te.morphTargetsCount!==ge)&&(be=!0):(be=!0,te.__version=ut.version);let Pn=te.currentProgram;be===!0&&(Pn=Oi(ut,j,J));let Si=!1,Gn=!1,bn=!1;const ke=Pn.getUniforms(),Vn=te.uniforms;if(Ot.useProgram(Pn.program)&&(Si=!0,Gn=!0,bn=!0),ut.id!==R&&(R=ut.id,Gn=!0),Si||D!==C){Ot.buffers.depth.getReversed()&&C.reversedDepth!==!0&&(C._reversedDepth=!0,C.updateProjectionMatrix()),ke.setValue(H,"projectionMatrix",C.projectionMatrix),ke.setValue(H,"viewMatrix",C.matrixWorldInverse);const Cn=ke.map.cameraPosition;Cn!==void 0&&Cn.setValue(H,wt.setFromMatrixPosition(C.matrixWorld)),se.logarithmicDepthBuffer&&ke.setValue(H,"logDepthBufFC",2/(Math.log(C.far+1)/Math.LN2)),(ut.isMeshPhongMaterial||ut.isMeshToonMaterial||ut.isMeshLambertMaterial||ut.isMeshBasicMaterial||ut.isMeshStandardMaterial||ut.isShaderMaterial)&&ke.setValue(H,"isOrthographic",C.isOrthographicCamera===!0),D!==C&&(D=C,Gn=!0,bn=!0)}if(J.isSkinnedMesh){ke.setOptional(H,J,"bindMatrix"),ke.setOptional(H,J,"bindMatrixInverse");const en=J.skeleton;en&&(en.boneTexture===null&&en.computeBoneTexture(),ke.setValue(H,"boneTexture",en.boneTexture,fe))}J.isBatchedMesh&&(ke.setOptional(H,J,"batchingTexture"),ke.setValue(H,"batchingTexture",J._matricesTexture,fe),ke.setOptional(H,J,"batchingIdTexture"),ke.setValue(H,"batchingIdTexture",J._indirectTexture,fe),ke.setOptional(H,J,"batchingColorTexture"),J._colorsTexture!==null&&ke.setValue(H,"batchingColorTexture",J._colorsTexture,fe));const On=ct.morphAttributes;if((On.position!==void 0||On.normal!==void 0||On.color!==void 0)&&St.update(J,ct,Pn),(Gn||te.receiveShadow!==J.receiveShadow)&&(te.receiveShadow=J.receiveShadow,ke.setValue(H,"receiveShadow",J.receiveShadow)),ut.isMeshGouraudMaterial&&ut.envMap!==null&&(Vn.envMap.value=Nt,Vn.flipEnvMap.value=Nt.isCubeTexture&&Nt.isRenderTargetTexture===!1?-1:1),ut.isMeshStandardMaterial&&ut.envMap===null&&j.environment!==null&&(Vn.envMapIntensity.value=j.environmentIntensity),Gn&&(ke.setValue(H,"toneMappingExposure",w.toneMappingExposure),te.needsLights&&is(Vn,bn),Et&&ut.fog===!0&&_t.refreshFogUniforms(Vn,Et),_t.refreshMaterialUniforms(Vn,ut,Y,tt,y.state.transmissionRenderTarget[C.id]),du.upload(H,Hs(te),Vn,fe)),ut.isShaderMaterial&&ut.uniformsNeedUpdate===!0&&(du.upload(H,Hs(te),Vn,fe),ut.uniformsNeedUpdate=!1),ut.isSpriteMaterial&&ke.setValue(H,"center",J.center),ke.setValue(H,"modelViewMatrix",J.modelViewMatrix),ke.setValue(H,"normalMatrix",J.normalMatrix),ke.setValue(H,"modelMatrix",J.matrixWorld),ut.isShaderMaterial||ut.isRawShaderMaterial){const en=ut.uniformsGroups;for(let Cn=0,Gs=en.length;Cn<Gs;Cn++){const qn=en[Cn];he.update(qn,Pn),he.bind(qn,Pn)}}return Pn}function is(C,j){C.ambientLightColor.needsUpdate=j,C.lightProbe.needsUpdate=j,C.directionalLights.needsUpdate=j,C.directionalLightShadows.needsUpdate=j,C.pointLights.needsUpdate=j,C.pointLightShadows.needsUpdate=j,C.spotLights.needsUpdate=j,C.spotLightShadows.needsUpdate=j,C.rectAreaLights.needsUpdate=j,C.hemisphereLights.needsUpdate=j}function Ma(C){return C.isMeshLambertMaterial||C.isMeshToonMaterial||C.isMeshPhongMaterial||C.isMeshStandardMaterial||C.isShadowMaterial||C.isShaderMaterial&&C.lights===!0}this.getActiveCubeFace=function(){return O},this.getActiveMipmapLevel=function(){return F},this.getRenderTarget=function(){return G},this.setRenderTargetTextures=function(C,j,ct){const ut=kt.get(C);ut.__autoAllocateDepthBuffer=C.resolveDepthBuffer===!1,ut.__autoAllocateDepthBuffer===!1&&(ut.__useRenderToTexture=!1),kt.get(C.texture).__webglTexture=j,kt.get(C.depthTexture).__webglTexture=ut.__autoAllocateDepthBuffer?void 0:ct,ut.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(C,j){const ct=kt.get(C);ct.__webglFramebuffer=j,ct.__useDefaultFramebuffer=j===void 0};const fn=H.createFramebuffer();this.setRenderTarget=function(C,j=0,ct=0){G=C,O=j,F=ct;let ut=!0,J=null,Et=!1,Ut=!1;if(C){const Nt=kt.get(C);if(Nt.__useDefaultFramebuffer!==void 0)Ot.bindFramebuffer(H.FRAMEBUFFER,null),ut=!1;else if(Nt.__webglFramebuffer===void 0)fe.setupRenderTarget(C);else if(Nt.__hasExternalTextures)fe.rebindTextures(C,kt.get(C.texture).__webglTexture,kt.get(C.depthTexture).__webglTexture);else if(C.depthBuffer){const jt=C.depthTexture;if(Nt.__boundDepthTexture!==jt){if(jt!==null&&kt.has(jt)&&(C.width!==jt.image.width||C.height!==jt.image.height))throw new Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");fe.setupDepthRenderbuffer(C)}}const ee=C.texture;(ee.isData3DTexture||ee.isDataArrayTexture||ee.isCompressedArrayTexture)&&(Ut=!0);const ie=kt.get(C).__webglFramebuffer;C.isWebGLCubeRenderTarget?(Array.isArray(ie[j])?J=ie[j][ct]:J=ie[j],Et=!0):C.samples>0&&fe.useMultisampledRTT(C)===!1?J=kt.get(C).__webglMultisampledFramebuffer:Array.isArray(ie)?J=ie[ct]:J=ie,V.copy(C.viewport),W.copy(C.scissor),nt=C.scissorTest}else V.copy(Z).multiplyScalar(Y).floor(),W.copy(dt).multiplyScalar(Y).floor(),nt=vt;if(ct!==0&&(J=fn),Ot.bindFramebuffer(H.FRAMEBUFFER,J)&&ut&&Ot.drawBuffers(C,J),Ot.viewport(V),Ot.scissor(W),Ot.setScissorTest(nt),Et){const Nt=kt.get(C.texture);H.framebufferTexture2D(H.FRAMEBUFFER,H.COLOR_ATTACHMENT0,H.TEXTURE_CUBE_MAP_POSITIVE_X+j,Nt.__webglTexture,ct)}else if(Ut){const Nt=j;for(let ee=0;ee<C.textures.length;ee++){const ie=kt.get(C.textures[ee]);H.framebufferTextureLayer(H.FRAMEBUFFER,H.COLOR_ATTACHMENT0+ee,ie.__webglTexture,ct,Nt)}}else if(C!==null&&ct!==0){const Nt=kt.get(C.texture);H.framebufferTexture2D(H.FRAMEBUFFER,H.COLOR_ATTACHMENT0,H.TEXTURE_2D,Nt.__webglTexture,ct)}R=-1},this.readRenderTargetPixels=function(C,j,ct,ut,J,Et,Ut,Ft=0){if(!(C&&C.isWebGLRenderTarget)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let Nt=kt.get(C).__webglFramebuffer;if(C.isWebGLCubeRenderTarget&&Ut!==void 0&&(Nt=Nt[Ut]),Nt){Ot.bindFramebuffer(H.FRAMEBUFFER,Nt);try{const ee=C.textures[Ft],ie=ee.format,jt=ee.type;if(!se.textureFormatReadable(ie)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!se.textureTypeReadable(jt)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}j>=0&&j<=C.width-ut&&ct>=0&&ct<=C.height-J&&(C.textures.length>1&&H.readBuffer(H.COLOR_ATTACHMENT0+Ft),H.readPixels(j,ct,ut,J,Xt.convert(ie),Xt.convert(jt),Et))}finally{const ee=G!==null?kt.get(G).__webglFramebuffer:null;Ot.bindFramebuffer(H.FRAMEBUFFER,ee)}}},this.readRenderTargetPixelsAsync=async function(C,j,ct,ut,J,Et,Ut,Ft=0){if(!(C&&C.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let Nt=kt.get(C).__webglFramebuffer;if(C.isWebGLCubeRenderTarget&&Ut!==void 0&&(Nt=Nt[Ut]),Nt)if(j>=0&&j<=C.width-ut&&ct>=0&&ct<=C.height-J){Ot.bindFramebuffer(H.FRAMEBUFFER,Nt);const ee=C.textures[Ft],ie=ee.format,jt=ee.type;if(!se.textureFormatReadable(ie))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!se.textureTypeReadable(jt))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");const me=H.createBuffer();H.bindBuffer(H.PIXEL_PACK_BUFFER,me),H.bufferData(H.PIXEL_PACK_BUFFER,Et.byteLength,H.STREAM_READ),C.textures.length>1&&H.readBuffer(H.COLOR_ATTACHMENT0+Ft),H.readPixels(j,ct,ut,J,Xt.convert(ie),Xt.convert(jt),0);const De=G!==null?kt.get(G).__webglFramebuffer:null;Ot.bindFramebuffer(H.FRAMEBUFFER,De);const Ze=H.fenceSync(H.SYNC_GPU_COMMANDS_COMPLETE,0);return H.flush(),await OS(H,Ze,4),H.bindBuffer(H.PIXEL_PACK_BUFFER,me),H.getBufferSubData(H.PIXEL_PACK_BUFFER,0,Et),H.deleteBuffer(me),H.deleteSync(Ze),Et}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")},this.copyFramebufferToTexture=function(C,j=null,ct=0){const ut=Math.pow(2,-ct),J=Math.floor(C.image.width*ut),Et=Math.floor(C.image.height*ut),Ut=j!==null?j.x:0,Ft=j!==null?j.y:0;fe.setTexture2D(C,0),H.copyTexSubImage2D(H.TEXTURE_2D,ct,0,0,Ut,Ft,J,Et),Ot.unbindTexture()};const El=H.createFramebuffer(),Tl=H.createFramebuffer();this.copyTextureToTexture=function(C,j,ct=null,ut=null,J=0,Et=null){Et===null&&(J!==0?(yl("WebGLRenderer: copyTextureToTexture function signature has changed to support src and dst mipmap levels."),Et=J,J=0):Et=0);let Ut,Ft,Nt,ee,ie,jt,me,De,Ze;const Ie=C.isCompressedTexture?C.mipmaps[Et]:C.image;if(ct!==null)Ut=ct.max.x-ct.min.x,Ft=ct.max.y-ct.min.y,Nt=ct.isBox3?ct.max.z-ct.min.z:1,ee=ct.min.x,ie=ct.min.y,jt=ct.isBox3?ct.min.z:0;else{const On=Math.pow(2,-J);Ut=Math.floor(Ie.width*On),Ft=Math.floor(Ie.height*On),C.isDataArrayTexture?Nt=Ie.depth:C.isData3DTexture?Nt=Math.floor(Ie.depth*On):Nt=1,ee=0,ie=0,jt=0}ut!==null?(me=ut.x,De=ut.y,Ze=ut.z):(me=0,De=0,Ze=0);const ge=Xt.convert(j.format),te=Xt.convert(j.type);let je;j.isData3DTexture?(fe.setTexture3D(j,0),je=H.TEXTURE_3D):j.isDataArrayTexture||j.isCompressedArrayTexture?(fe.setTexture2DArray(j,0),je=H.TEXTURE_2D_ARRAY):(fe.setTexture2D(j,0),je=H.TEXTURE_2D),H.pixelStorei(H.UNPACK_FLIP_Y_WEBGL,j.flipY),H.pixelStorei(H.UNPACK_PREMULTIPLY_ALPHA_WEBGL,j.premultiplyAlpha),H.pixelStorei(H.UNPACK_ALIGNMENT,j.unpackAlignment);const be=H.getParameter(H.UNPACK_ROW_LENGTH),Pn=H.getParameter(H.UNPACK_IMAGE_HEIGHT),Si=H.getParameter(H.UNPACK_SKIP_PIXELS),Gn=H.getParameter(H.UNPACK_SKIP_ROWS),bn=H.getParameter(H.UNPACK_SKIP_IMAGES);H.pixelStorei(H.UNPACK_ROW_LENGTH,Ie.width),H.pixelStorei(H.UNPACK_IMAGE_HEIGHT,Ie.height),H.pixelStorei(H.UNPACK_SKIP_PIXELS,ee),H.pixelStorei(H.UNPACK_SKIP_ROWS,ie),H.pixelStorei(H.UNPACK_SKIP_IMAGES,jt);const ke=C.isDataArrayTexture||C.isData3DTexture,Vn=j.isDataArrayTexture||j.isData3DTexture;if(C.isDepthTexture){const On=kt.get(C),en=kt.get(j),Cn=kt.get(On.__renderTarget),Gs=kt.get(en.__renderTarget);Ot.bindFramebuffer(H.READ_FRAMEBUFFER,Cn.__webglFramebuffer),Ot.bindFramebuffer(H.DRAW_FRAMEBUFFER,Gs.__webglFramebuffer);for(let qn=0;qn<Nt;qn++)ke&&(H.framebufferTextureLayer(H.READ_FRAMEBUFFER,H.COLOR_ATTACHMENT0,kt.get(C).__webglTexture,J,jt+qn),H.framebufferTextureLayer(H.DRAW_FRAMEBUFFER,H.COLOR_ATTACHMENT0,kt.get(j).__webglTexture,Et,Ze+qn)),H.blitFramebuffer(ee,ie,Ut,Ft,me,De,Ut,Ft,H.DEPTH_BUFFER_BIT,H.NEAREST);Ot.bindFramebuffer(H.READ_FRAMEBUFFER,null),Ot.bindFramebuffer(H.DRAW_FRAMEBUFFER,null)}else if(J!==0||C.isRenderTargetTexture||kt.has(C)){const On=kt.get(C),en=kt.get(j);Ot.bindFramebuffer(H.READ_FRAMEBUFFER,El),Ot.bindFramebuffer(H.DRAW_FRAMEBUFFER,Tl);for(let Cn=0;Cn<Nt;Cn++)ke?H.framebufferTextureLayer(H.READ_FRAMEBUFFER,H.COLOR_ATTACHMENT0,On.__webglTexture,J,jt+Cn):H.framebufferTexture2D(H.READ_FRAMEBUFFER,H.COLOR_ATTACHMENT0,H.TEXTURE_2D,On.__webglTexture,J),Vn?H.framebufferTextureLayer(H.DRAW_FRAMEBUFFER,H.COLOR_ATTACHMENT0,en.__webglTexture,Et,Ze+Cn):H.framebufferTexture2D(H.DRAW_FRAMEBUFFER,H.COLOR_ATTACHMENT0,H.TEXTURE_2D,en.__webglTexture,Et),J!==0?H.blitFramebuffer(ee,ie,Ut,Ft,me,De,Ut,Ft,H.COLOR_BUFFER_BIT,H.NEAREST):Vn?H.copyTexSubImage3D(je,Et,me,De,Ze+Cn,ee,ie,Ut,Ft):H.copyTexSubImage2D(je,Et,me,De,ee,ie,Ut,Ft);Ot.bindFramebuffer(H.READ_FRAMEBUFFER,null),Ot.bindFramebuffer(H.DRAW_FRAMEBUFFER,null)}else Vn?C.isDataTexture||C.isData3DTexture?H.texSubImage3D(je,Et,me,De,Ze,Ut,Ft,Nt,ge,te,Ie.data):j.isCompressedArrayTexture?H.compressedTexSubImage3D(je,Et,me,De,Ze,Ut,Ft,Nt,ge,Ie.data):H.texSubImage3D(je,Et,me,De,Ze,Ut,Ft,Nt,ge,te,Ie):C.isDataTexture?H.texSubImage2D(H.TEXTURE_2D,Et,me,De,Ut,Ft,ge,te,Ie.data):C.isCompressedTexture?H.compressedTexSubImage2D(H.TEXTURE_2D,Et,me,De,Ie.width,Ie.height,ge,Ie.data):H.texSubImage2D(H.TEXTURE_2D,Et,me,De,Ut,Ft,ge,te,Ie);H.pixelStorei(H.UNPACK_ROW_LENGTH,be),H.pixelStorei(H.UNPACK_IMAGE_HEIGHT,Pn),H.pixelStorei(H.UNPACK_SKIP_PIXELS,Si),H.pixelStorei(H.UNPACK_SKIP_ROWS,Gn),H.pixelStorei(H.UNPACK_SKIP_IMAGES,bn),Et===0&&j.generateMipmaps&&H.generateMipmap(je),Ot.unbindTexture()},this.initRenderTarget=function(C){kt.get(C).__webglFramebuffer===void 0&&fe.setupRenderTarget(C)},this.initTexture=function(C){C.isCubeTexture?fe.setTextureCube(C,0):C.isData3DTexture?fe.setTexture3D(C,0):C.isDataArrayTexture||C.isCompressedArrayTexture?fe.setTexture2DArray(C,0):fe.setTexture2D(C,0),Ot.unbindTexture()},this.resetState=function(){O=0,F=0,G=null,Ot.reset(),Dt.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return Xi}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(t){this._outputColorSpace=t;const n=this.getContext();n.drawingBufferColorSpace=Ce._getDrawingBufferColorSpace(t),n.unpackColorSpace=Ce._getUnpackColorSpace()}}function pu(r,t=!1){const n=r[0].index!==null,a=new Set(Object.keys(r[0].attributes)),o=new Set(Object.keys(r[0].morphAttributes)),c={},u={},h=r[0].morphTargetsRelative,d=new sn;let p=0;for(let g=0;g<r.length;++g){const v=r[g];let _=0;if(n!==(v.index!==null))return console.error("THREE.BufferGeometryUtils: .mergeGeometries() failed with geometry at index "+g+". All geometries must have compatible attributes; make sure index attribute exists among all geometries, or in none of them."),null;for(const x in v.attributes){if(!a.has(x))return console.error("THREE.BufferGeometryUtils: .mergeGeometries() failed with geometry at index "+g+'. All geometries must have compatible attributes; make sure "'+x+'" attribute exists among all geometries, or in none of them.'),null;c[x]===void 0&&(c[x]=[]),c[x].push(v.attributes[x]),_++}if(_!==a.size)return console.error("THREE.BufferGeometryUtils: .mergeGeometries() failed with geometry at index "+g+". Make sure all geometries have the same number of attributes."),null;if(h!==v.morphTargetsRelative)return console.error("THREE.BufferGeometryUtils: .mergeGeometries() failed with geometry at index "+g+". .morphTargetsRelative must be consistent throughout all geometries."),null;for(const x in v.morphAttributes){if(!o.has(x))return console.error("THREE.BufferGeometryUtils: .mergeGeometries() failed with geometry at index "+g+".  .morphAttributes must be consistent throughout all geometries."),null;u[x]===void 0&&(u[x]=[]),u[x].push(v.morphAttributes[x])}if(t){let x;if(n)x=v.index.count;else if(v.attributes.position!==void 0)x=v.attributes.position.count;else return console.error("THREE.BufferGeometryUtils: .mergeGeometries() failed with geometry at index "+g+". The geometry must have either an index or a position attribute"),null;d.addGroup(p,x,g),p+=x}}if(n){let g=0;const v=[];for(let _=0;_<r.length;++_){const x=r[_].index;for(let S=0;S<x.count;++S)v.push(x.getX(S)+g);g+=r[_].attributes.position.count}d.setIndex(v)}for(const g in c){const v=E_(c[g]);if(!v)return console.error("THREE.BufferGeometryUtils: .mergeGeometries() failed while trying to merge the "+g+" attribute."),null;d.setAttribute(g,v)}for(const g in u){const v=u[g][0].length;if(v===0)break;d.morphAttributes=d.morphAttributes||{},d.morphAttributes[g]=[];for(let _=0;_<v;++_){const x=[];for(let E=0;E<u[g].length;++E)x.push(u[g][E][_]);const S=E_(x);if(!S)return console.error("THREE.BufferGeometryUtils: .mergeGeometries() failed while trying to merge the "+g+" morphAttribute."),null;d.morphAttributes[g].push(S)}}return d}function E_(r){let t,n,a,o=-1,c=0;for(let p=0;p<r.length;++p){const g=r[p];if(t===void 0&&(t=g.array.constructor),t!==g.array.constructor)return console.error("THREE.BufferGeometryUtils: .mergeAttributes() failed. BufferAttribute.array must be of consistent array types across matching attributes."),null;if(n===void 0&&(n=g.itemSize),n!==g.itemSize)return console.error("THREE.BufferGeometryUtils: .mergeAttributes() failed. BufferAttribute.itemSize must be consistent across matching attributes."),null;if(a===void 0&&(a=g.normalized),a!==g.normalized)return console.error("THREE.BufferGeometryUtils: .mergeAttributes() failed. BufferAttribute.normalized must be consistent across matching attributes."),null;if(o===-1&&(o=g.gpuType),o!==g.gpuType)return console.error("THREE.BufferGeometryUtils: .mergeAttributes() failed. BufferAttribute.gpuType must be consistent across matching attributes."),null;c+=g.count*n}const u=new t(c),h=new hi(u,n,a);let d=0;for(let p=0;p<r.length;++p){const g=r[p];if(g.isInterleavedBufferAttribute){const v=d/n;for(let _=0,x=g.count;_<x;_++)for(let S=0;S<n;S++){const E=g.getComponent(_,S);h.setComponent(_+v,S,E)}}else u.set(g.array,d);d+=g.count*n}return o!==void 0&&(h.gpuType=o),h}const mu={name:"CopyShader",uniforms:{tDiffuse:{value:null},opacity:{value:1}},vertexShader:`
...
`)),_.fragmentShader=x+_.fragmentShader;let S="";if(p?S=`{
          ...
          float moss=min(mossCoverage(vOceanWorld,wn,arm.r,${v}),.10);
...
${S}`),p){const E=n==="sand"?"0.5":"0.62";_.fragmentShader=_.fragmentShader.replace("#include <roughnessmap_fragment>",`#include <roughnessmap_fragment>
          {
...
}`,bw=`varying vec2 vUv;varying vec3 vLocal;varying vec3 vView;
void main(){
  vUv=uv;vLocal=position;
  vec4 mv=modelViewMatrix*vec4(position,1.);
  vView=mv.xyz;gl_Position=projectionMatrix*mv;
}`,Ew=`varying vec2 vUv;varying vec3 vLocal;varying vec3 vView;

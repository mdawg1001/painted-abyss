...
/**
 * Cover: floor-to-head-height blockers (stacked ammo crates, concrete blast walls).
 ...
 */
export const SURVIVAL_COVER:{x:number;z:number;hx:number;hz:number;kind:'crates'|'wall'}[]=[
